...
<title><?php echo $row_metaDatos["titulo"]." | Buscador Avanzado | Paso 2"; ?></title>
<!-- InstanceEndEditable -->
      ...
      <div class="row">
        <div class="col-main col-sm-9 col-xs-12">
          ...
          <div class="page-content checkout-page">
            ...
            <h4 class="checkout-sep">2. Selecciona su Capacidad M&aacute;xima</h4>
            <div class="box-border">
              <div class="row">
                <div class="col-sm-6">
                  <h5>¿Con cu&aacute;nto peso cargar&aacute;s la escalera?</h5>
                  <p>Ind&iacute;canos los kilos m&aacute;ximos que soportar&aacute; tu nueva escalera</p>
                  <form name="buscadorAvanzadoForm" action="<?php echo $editFormAction; ?>" method="post">
				  <ul>
                    <li>
                      <label class="required">Capacidad M&aacute;xima</label>
                    	<select class="input form-control" name="capMax">
                          <option value="90">90 kls.</option>
                          <option value="100">100 kls.</option>
                          <option value="110">110 kls.</option>
                          <option value="120">120 kls.</option>
                          <option value="130">130 kls.</option>
                          <option value="140">140 kls.</option>
                          <option value="150">150 kls.</option>
                          <option value="160">160 kls.</option>
                          <option value="170">170 kls.</option>
                    	</select>
                    </li>
                  </ul>
                  <br>
				  <input type="hidden" name="id" value="<?php echo $row_busquedaAvanzadaIP["id"]; ?>">
                  <button class="button"><i class="fa fa-angle-double-right"></i>&nbsp; <span>Continuar</span></button>
