...
<title><?php echo $row_metaDatos["titulo"]." | Buscador Avanzado | Paso 4"; ?></title>
<!-- InstanceEndEditable -->
      ...
      <div class="row">
        <div class="col-main col-sm-9 col-xs-12">
          ...
          <div class="page-content checkout-page">
            ...
            <h4 class="checkout-sep">4. Cantidad de Pelda&ntilde;os</h4>
            <div class="box-border">
              <div class="row">
                <div class="col-sm-6">
                  <h5>¿Cu&aacute;ntos pelda&ntilde;os necesitas?</h5>
                  <p>Selecciona el n&uacute;mero de pelda&ntilde;os que necesitas</p>
                  <form name="buscadorAvanzadoForm" action="<?php echo $editFormAction; ?>" method="post">
				  <ul>
                    <li>
                      <label class="required">Cantidad de Pelda&ntilde;os</label>
                    	<select class="input form-control" name="peldanos">
                          <option value="2">2 pelda&ntilde;os</option>
                          <option value="3">3 pelda&ntilde;os</option>
                          <option value="4">4 pelda&ntilde;os</option>
                          <option value="5">5 pelda&ntilde;os</option>
                          <option value="6">6 pelda&ntilde;os</option>
                          <option value="7">7 pelda&ntilde;os</option>
                          <option value="8">8 pelda&ntilde;os</option>
                          <option value="9">9 pelda&ntilde;os</option>
                          <option value="10">10 pelda&ntilde;os</option>
                          <option value="12">12 pelda&ntilde;os</option>
                          <option value="14">14 pelda&ntilde;os</option>
                          <option value="16">16 pelda&ntilde;os</option>
                          <option value="18">18 pelda&ntilde;os</option>
                          <option value="20">20 pelda&ntilde;os</option>
                          <option value="24">24 pelda&ntilde;os</option>
                          <option value="28">28 pelda&ntilde;os</option>
                          <option value="32">32 pelda&ntilde;os</option>
                          <option value="36">36 pelda&ntilde;os</option>
                          <option value="40">40 pelda&ntilde;os</option>
                    	</select>
                    </li>
                  </ul>
                  <br>
                  <input type="hidden" name="id" value="<?php echo $row_busquedaAvanzadaIP["id"]; ?>">
                  <button class="button"><i class="fa fa-angle-double-right"></i>&nbsp; <span>Ver Resultados</span></button>
				  <input type="hidden" name="MM_update" value="buscadorAvanzadoForm">
				  </form>
                </div>
              </div>
            </div>
