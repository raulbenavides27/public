...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "buscadorAvanzadoForm")) {
  $updateSQL = sprintf("UPDATE buscadorAvanzado SET alturaMax=%s WHERE id=%s",
                       GetSQLValueString($_POST['alturaMax'], "text"),
...
<title><?php echo $row_metaDatos["titulo"]." | Buscador Avanzado | Paso 3"; ?></title>
<!-- InstanceEndEditable -->
      ...
      <div class="row">
        <div class="col-main col-sm-9 col-xs-12">
          ...
          <div class="page-content checkout-page">
			...
			<h4 class="checkout-sep">3. Altura M&aacute;xima</h4>
            <div class="box-border">
              <div class="row">
                <div class="col-sm-6">
                  <h5>¿A qu&eacute; altura necesitas llegar?</h5>
                  <p>Ind&iacute;canos la altura que precisas alcanzar</p>
                  <form name="buscadorAvanzadoForm" action="<?php echo $editFormAction; ?>" method="post">
				  <ul>
                    <li>
                      <label class="required">Altura M&aacute;xima</label>
                    	<select class="input form-control" name="alturaMax">
                          <option value="3">3 mts.</option>
                          ...
                          <option value="11">11 mts.</option>
                          <option value="12">12 mts.</option>
                    	</select>
                    </li>
                  </ul>
                  <br>
