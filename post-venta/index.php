...
$query_postVentaContenido = "SELECT * FROM postVenta WHERE postVenta.estado = '1' ORDER BY postVenta.id DESC";
$postVentaContenido = mysqli_query($DKKfront, $query_postVentaContenido);
$row_postVentaContenido = mysqli_fetch_assoc($postVentaContenido);
$totalRows_postVentaContenido = mysqli_num_rows($postVentaContenido);
...
<title><?php echo $row_metaDatos["titulo"]." | Post Venta "; ?></title>
<!-- InstanceEndEditable -->
  ...
  <div class="main container">
     ...
     <div class="about-page">
        <div class="col-xs-12 col-sm-6"> 
          ...
          <h1>Post<span class="text_color">Venta</span></h1>
          <p><?php echo $row_postVentaContenido["contenido"]; ?></p>
        </div>
        <div class="col-xs-12 col-sm-6">
          <div class="single-img-add sidebar-add-slider">
            <div id="carousel-example-generic" class="carousel slide" data-ride="carousel"> 
              ...
              <div class="carousel-inner" role="listbox">
                <div class="item active"> <img src="../images/<?php echo $row_postVentaContenido["imagen1"]; ?>" alt="<?php echo $row_metaDatos["titulo"]; ?>"> </div>
                <div class="item"> <img src="../images/<?php echo $row_postVentaContenido["imagen2"]; ?>" alt="<?php echo $row_metaDatos["titulo"]; ?>"> </div>
                <div class="item"> <img src="../images/<?php echo $row_postVentaContenido["imagen3"]; ?>" alt="<?php echo $row_metaDatos["titulo"]; ?>"> </div>
              </div>
            </div>
          </div>
        </div>
