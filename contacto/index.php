...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "contactoForm")) {
  ...
  $insertSQL = sprintf("INSERT INTO contacto (nombre, apellido, correo, telefono, asunto, mensaje, fechaID, fecha, ip, estado) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
...
$query_ultimoContacto = "SELECT * FROM contacto WHERE contacto.estado = '1' ORDER BY contacto.id DESC LIMIT 1";
$ultimoContacto = mysqli_query($DKKfront, $query_ultimoContacto);
...
<title><?php echo $row_metaDatos["titulo"]." | Contacto"; ?></title>
<!-- InstanceEndEditable -->
...
<!--<script type="text/javascript">
 if (screen.width<500) {
window.location="http://mobile.prodalum.cl/home/#!/../contacto";
}
</script> -->
<!-- InstanceEndEditable -->
<!-- script para captcha -->
...
function onClick(e) {
  ...
  grecaptcha.enterprise.ready(async () => {
    const token = await grecaptcha.enterprise.execute('6LeqHF0oAAAAAPbE8ycPVtWzN0-sr-H0F7AC9bMZ', {action: 'LOGIN'});
      ...
      <div class="row">
        <section class="col-main col-sm-12">
          <div id="contact" class="page-content page-contact">
            ...
            <div id="message-box-conact">Escr&iacute;benos y te responderemos a la brevedad.</div>
            <div class="row">
              <div class="col-xs-12 col-sm-6" id="contact_form_map">
                <h3 class="page-subheading">Estamos a tu servicio</h3>
                <p>Completa todos los campos y env&iacute;anos un mensaje. Estaremos felices de responderte.</p>
                <br/>
                <ul class="store_info">
                  <li><i class="fa fa-home"></i><a href="<?php echo $row_metaDatos["googleMaps"]; ?>" target="_blank"><?php echo $row_metaDatos["direccion"]; ?></a></li>
                  <li><i class="fa fa-phone"></i><span><?php echo $row_metaDatos["telefono"]; ?></span></li>
                 <!-- <li><i class="fa fa-print"></i><span><?php echo $row_metaDatos["fax"]; ?></span></li> -->
                  <li><i class="fa fa-envelope"></i>Email: <span><a href="mailto:<?php echo $row_metaDatos["correo"]; ?>"><?php echo $row_metaDatos["correo"]; ?></a></span></li>
                </ul>
              </div>
              <div class="col-sm-6">
	   	        <?php if ($row_ultimoContacto["ip"] == $ip) { ?>
                <div id="div2" class="successmes">
				  <div class="message-box-wrap">
 	                <button class="close-but" id="colosebut2">cerrar</button>
	                Mensaje Enviado <strong>con &eacute;xito</strong>. Te responderemos a la brevedad.
                  </div>
		        </div>
                ...
                <div class="contact-form-box">
                  <form method="POST" action="<?php echo $editFormAction; ?>" name="contactoForm">
                  <div class="form-selector">
                    <label>Nombre</label>
                    <input type="text" class="form-control input-sm" id="nombre" name="nombre" required="required" />
                  </div>
                  <div class="form-selector">
                  ...
                  <div class="form-selector">
                    <label>Correo</label>
                    <input type="email" class="form-control input-sm" id="correo" name="correo" required="required" />
                  </div>
                  <div class="form-selector">
                    <label>Tel&eacute;fono</label>
                    <input type="tel" class="form-control input-sm" id="telefono" name="telefono" required="required" />
                  </div>
                  <div class="form-selector">
                    <label>Asunto</label>
                    <input type="text" class="form-control input-sm" id="asunto" name="asunto" required="required" value="Contacto desde la Web"/>
                  </div>
                  <div class="form-selector">
                    <label>Mensaje</label>
                    <textarea class="form-control input-sm" rows="10" id="mensaje" name="mensaje" style="height:150px;" required="required" ></textarea>
                  </div>
                  <!-- recaptcha -->
                  
                   <div class="g-recaptcha" data-sitekey="6LfbNmMoAAAAAG47QrZY0GafpFXH_eDgaSdr6-C3" required="required" ></div>
                  
                  <br>
                  <div class="form-selector">
                    <button class="button"><i class="icon-paper-plane icons"></i>&nbsp; <span>Enviar Mensaje</span></button>
                    <input type="hidden" name="ip" value="<?php echo $ip; ?>">
                    <input type="hidden" name="fecha" value="<?php echo $fecha; ?>">
                    <input type="hidden" name="fechaID" value="<?php echo $fechaID; ?>">
                    <input type="hidden" name="estado" value="1">
