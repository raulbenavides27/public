...
$query_nosotrosContenido = "SELECT * FROM nosotros WHERE nosotros.estado = '1' ORDER BY nosotros.id DESC";
$nosotrosContenido = mysqli_query($DKKfront, $query_nosotrosContenido);
$row_nosotrosContenido = mysqli_fetch_assoc($nosotrosContenido);
$totalRows_nosotrosContenido = mysqli_num_rows($nosotrosContenido);
...
<title><?php echo $row_metaDatos["titulo"]." | Misión "; ?></title>
<!-- InstanceEndEditable -->
      ...
      <div class="row">
        <div class="col-xs-12">
          <ul>
            ...
            <li><strong>Misi&oacute;n</strong></li>
          </ul>
        </div>
      </div>
    </div>
  ...
  <div class="main container">
     ...
     <div class="about-page">
        <div class="col-xs-12 col-sm-6"> 
          ...
          <h1>Nuestra <span class="text_color">MISI&Oacute;N</span></h1>
          <!-- <p>L&iacute;deres en Escalas, Ventanas, Espejos y Shower Doors.</p> -->
          <p><?php echo $row_nosotrosContenido["mision"]; ?></p>
        </div>
        <div class="col-xs-12 col-sm-6">
          <div class="single-img-add sidebar-add-slider">
            <div id="carousel-example-generic" class="carousel slide" data-ride="carousel"> 
              ...
              <div class="carousel-inner" role="listbox">
                <div class="item active"> <img src="../images/<?php echo $row_nosotrosContenido["imagen1"]; ?>" alt="<?php echo $row_metaDatos["titulo"]; ?>"> </div>
                <div class="item"> <img src="../images/<?php echo $row_nosotrosContenido["imagen2"]; ?>" alt="<?php echo $row_metaDatos["titulo"]; ?>"> </div>
                <div class="item"> <img src="../images/<?php echo $row_nosotrosContenido["imagen3"]; ?>" alt="<?php echo $row_metaDatos["titulo"]; ?>"> </div>
              </div>
            </div>
          </div>
        </div>
...
mysqli_free_result($nosotrosContenido);
?>
