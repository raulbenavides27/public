...
<title><?php echo $row_metaDatos["titulo"]." | Historia "; ?></title>
<!-- InstanceEndEditable -->
  ...
  <div class="main container">
     ...
     <div class="about-page">
        <div class="col-xs-12 col-sm-6"> 
          ...
          <h1>Somos <span class="text_color">PRODALUM</span></h1>
          <p>L&iacute;deres en Escalas, Ventanas, Espejos y Shower Doors.</p>
          <p><?php echo $row_nosotrosContenido["laEmpresa"]; ?></p>
        </div>
        <div class="col-xs-12 col-sm-6">
          <div class='embed-container'>
            <iframe src="https://player.vimeo.com/video/270751104" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
          </div>
        </div>
      </div>
