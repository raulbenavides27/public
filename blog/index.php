...
$query_blogPosts = "SELECT * FROM blog WHERE blog.estado = '1' ORDER BY blog.id DESC";
$query_limit_blogPosts = sprintf("%s LIMIT %d, %d", $query_blogPosts, $startRow_blogPosts, $maxRows_blogPosts);
$blogPosts = mysqli_query($DKKfront, $query_limit_blogPosts);
...
<title><?php echo $row_metaDatos["titulo"]." | Blog"; ?></title>
<!-- InstanceEndEditable -->
