...
$query_postSEO = sprintf("SELECT * FROM blog WHERE blog.tituloSEO = '$seo'");
$postSEO = mysqli_query($DKKfront, $query_postSEO);
$row_postSEO = mysqli_fetch_assoc($postSEO);
$totalRows_postSEO = mysqli_num_rows($postSEO);

$idPost = $row_postSEO["id"];
...
//Actualizar Visita
  $updateSQL = sprintf("UPDATE blog SET blog.visitas = blog.visitas +1 WHERE blog.id = '$idPost' AND blog.estado = '1'");
...
<title><?php echo $row_metaDatos["titulo"]." | Blog | ".$row_postSEO["titulo"]; ?></title>
<!-- InstanceEndEditable -->
        ...
        <div class="col-xs-12 col-sm-9">
          <div class="entry-detail">
            ...
            <div class="entry-photo">
              <figure><img src="../images/blog/<?php echo $row_postSEO["imagen"]; ?>" alt="<?php echo $row_postSEO["titulo"]; ?>"></figure>
            </div>
            <div class="entry-meta-data"> 
            
            <div class="blog-top-desc">
                    <div class="blog-date"> <?php echo $row_postSEO["dia"]." ".$row_postSEO["mes"]." ".$row_postSEO["ano"]; ?> </div>
                    <h1><a href="../posts/<?php echo $row_postSEO["tituloSEO"]; ?>"><?php echo $row_postSEO["titulo"]; ?></a></h1>
                    <div class="jtv-entry-meta"> <i class="fa fa-user-o"></i> <strong><?php echo $row_postSEO["autor"]; ?></strong> <a href="#"><i class="fa fa-commenting-o"></i> <strong><span class="fb-comments-count" data-href="https://www.prodalum.cl/posts/<?php echo $row_postSEO["tituloSEO"]; ?>"></span> Comentarios</strong></a> </div>
                  </div>
            ...
            <div class="content-text clearfix">
              <?php echo $row_postSEO["contenido"]; ?>
            </div>
          </div>
          <!-- comentarios -->
          ...
          <div class="best-title text-left">
            ...
            <div class="fb-comments" data-href="https://www.prodalum.cl/posts/<?php echo $row_postSEO["tituloSEO"]; ?>" data-width="100%" data-numposts="10"></div>
            </div>
          </div>
          <!-- END comentarios --> 
        </div>
