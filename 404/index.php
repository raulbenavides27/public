...
<title><?php echo $row_metaDatos["titulo"]." | 404"; ?></title>
<!-- InstanceEndEditable -->
...
<div id="page"> 
  ...
  <!-- InstanceBeginEditable name="contenido" -->
    ...
    <div class="error-page">
      <div class="container">
        <div class="error_pagenotfound"> <strong>4<span>0</span>4 </strong> <br />
          <b>Ups...</b> <em>No pudimos encontrar la página que buscaste.</em>
          <p>Vuelve al home e inténtalo de nuevo.</p>
          <br />
          <a href="../" class="button-back"><i class="icon-arrow-left-circle icons"></i>&nbsp; Ir al Home</a></div>
      </div>
    </div>
    <!-- END contenido -->
  <!-- InstanceEndEditable -->
