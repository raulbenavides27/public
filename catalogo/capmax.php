...
$query_categoriaSelect = sprintf("SELECT * FROM menuCategorias WHERE menuCategorias.categoriaSEO = '$categoriaSEO'");
...
$query_valorSelect = sprintf("SELECT * FROM escalasCapMax WHERE escalasCapMax.capMaxSEO = '$capmax'");
...
$query_productosShow = "SELECT * FROM productos WHERE productos.estado = '1' AND productos.categoriaSEO = 'escalas' AND productos.capMax = '$capMax' ORDER BY productos.id ASC";
...
$query_categoriasSide = "SELECT * FROM menuCategorias WHERE menuCategorias.estado = '1' AND NOT menuCategorias.categoriaSEO = '$categoriaSEO' ORDER BY menuCategorias.id ASC";
...
<title><?php echo $row_metaDatos["titulo"]." | ".$row_categoriaSelect["categoria"]." | Capacidad M&aacute;xima: ".$row_valorSelect["capMax"]." kilos"; ?></title>
<!-- InstanceEndEditable -->
      ...
      <div class="row">
        <div class="col-xs-12">
          <ul>
            ...
            <li><strong><?php echo "Cap. M&aacute;x. ".ucwords($row_valorSelect["capMax"])." kls."; ?></strong></li>
          </ul>
        </div>
      </div>
    </div>
        ...
        <div class="col-main col-sm-9 col-xs-12 col-sm-push-3">
          ...
          <div class="shop-inner">
            <div class="page-title">
              <h2><?php echo $row_categoriaSelect["categoria"]; ?> / Cap. M&aacute;x. <?php echo ucwords($row_valorSelect["capMax"]); ?> kls.</h2>
            </div>
            <div class="toolbar">
              <!-- <div class="view-mode">
                <ul>
