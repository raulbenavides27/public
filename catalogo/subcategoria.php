...
$query_subCategoriaSelect = sprintf("SELECT * FROM menuSubCategorias WHERE menuSubCategorias.subCategoriaSEO = '$subcategoria' AND menuSubCategorias.estado = '1'");
$subCategoriaSelect = mysqli_query($DKKfront, $query_subCategoriaSelect);
...
$subCategoriaSEO = $row_subCategoriaSelect["subCategoriaSEO"];

$query_familiasSelect = "SELECT * FROM menuSubCategoriasFamilias WHERE menuSubCategoriasFamilias.subCategoriaSEO = '$subcategoria' AND menuSubCategoriasFamilias.estado = '1' ORDER BY menuSubCategoriasFamilias.id ASC";
$familiasSelect = mysqli_query($DKKfront, $query_familiasSelect);
$row_familiasSelect = mysqli_fetch_assoc($familiasSelect);
$totalRows_familiasSelects = mysqli_num_rows($familiasSelect);
...
$query_productosShow = "SELECT * FROM productos WHERE productos.estado = '1' AND productos.subCategoriaSEO = '$subcategoria' ORDER BY productos.id DESC";
...
//actualizar visita
  $updateSQL = sprintf("UPDATE menuSubCategorias SET menuSubCategorias.visitas = menuSubCategorias.visitas +1 WHERE menuSubCategorias.subCategoriaSEO = '$subcategoria' AND menuSubCategorias.estado = '1'");
...
<title><?php echo $row_metaDatos["titulo"]." | Catálogo de Productos | ".$row_categoriaSelect["categoria"]." | ".$row_subCategoriaSelect["subCategoria"]; ?></title>
<!-- InstanceEndEditable -->
...
if (screen.width<500) {
window.location="http://mobile.prodalum.cl/home/#!/../catalogo/subcategoria.php?subcategoria=<?php echo $row_subCategoriaSelect["subCategoriaSEO"]; ?>";
}
</script>-->
<!-- InstanceEndEditable -->
</head>
      ...
      <div class="row">
        <div class="col-xs-12">
          <ul>
            ...
            <li><strong><?php echo $row_subCategoriaSelect["subCategoria"]; ?></strong></li>
          </ul>
        </div>
      </div>
    </div>
        ...
        <div class="col-main col-sm-9 col-xs-12 col-sm-push-3">
            ...
            <div class="slider-items-products">
              <div id="category-desc-slider" class="product-flexslider hidden-buttons">
                <div class="slider-items slider-width-col1 owl-carousel owl-Template"> 
                  ...
                  <!-- head
                  <div class="item"> <a href="#"><img alt="<?php echo "Cat&aacute;logo de Productos | ".$row_metaDatos["titulo"]; ?>" src="../images/catalogo/<?php echo $row_subCategoriaSelect["imagen"]; ?>"></a>
                    <div class="inner-info">
                      <div class="cat-img-title"> <span><?php echo $row_categoriaSelect["categoria"]; ?> / </span><span><?php echo $row_subCategoriaSelect["subCategoria"]; ?></span>
                        <h2 class="cat-heading"><?php echo $row_subCategoriaSelect["titulo"]; ?></h2>
                        <p><?php echo $row_subCategoriaSelect["bajada"]; ?></p>
                        <a class="info" href="../categoria/<?php echo $row_categoriaSelect["categoriaSEO"]; ?>">Ir a la Categor&iacute;a</a>
                      </div>
                    </div>
                  </div>
                  END head --> 
          ...
          <div class="shop-inner">
            ...
            <div class="page-title">
              <h2><?php echo $row_subCategoriaSelect["subCategoria"]; ?></h2>
            </div>
            <div class="toolbar">
              <!-- <div class="view-mode">
                <ul>
            ...
            <div class="row">
                <div class="col-xs-12">
                    <div class="page-title">
                      <h2><?php echo $row_familiasSelect["subCategoriaFamilia"]; ?></h2>
                    </div>
                    <div class="toolbar">
                      <!-- <div class="view-mode">
                        <ul>
                    ...
                    <div class="product-grid-area">
                      <ul class="products-grid">
                        <?php 
                          $familiaSelect = $row_familiasSelect["subCategoriaFamiliaSEO"];
                          $seleccionaProductos = mysqli_query($DKKfront, "SELECT * FROM productos WHERE productos.subCategoriaSEO = '$subCategoriaSEO' AND productos.subCategoriaFamiliaSEO = '$familiaSelect' AND productos.estado = '1' ORDER BY productos.id ASC"); while($sp = mysqli_fetch_array($seleccionaProductos)){ $seoProducto = $sp['nombreSEO']; ?>
                          <li class="item col-lg-4 col-md-4 col-sm-6 col-xs-6 ">
                            <div class="product-item">
                              <div class="item-inner">
                                <div class="product-thumbnail">
                                  <?php if (isset($sp["precioOferta"])) { ?>
                                    <div class="icon-sale-label sale-left">Oferta</div>
                                    <?php } ?>
                                  <?php if ($sp["novedad"] == '1') { ?><div class="icon-new-label new-right">Nuevo</div>
                                  <?php } ?>
                                  <div class="pr-img-area"> <a title="<?php echo $sp["nombre"]; ?>" href="../productos/<?php echo $sp["nombreSEO"]; ?>">
                                    <figure> <img class="first-img" src="../images/productos/<?php echo $sp["imagen1"]; ?>" alt="<?php echo $sp["nombre"]; ?>"> <img class="hover-img" src="../images/productos/<?php echo $sp["imagen1"]; ?>" alt="<?php echo $sp["nombre"]; ?>"></figure>
                                    </a> </div>
                                </div>
                                <div class="item-info">
                                  <div class="info-inner">
                                    <div class="item-title"> <a title="<?php echo $sp["nombre"]; ?>" href="../productos/<?php echo $sp["nombreSEO"]; ?>"><?php echo $sp["nombre"]; ?> </a> </div>
                                    <div class="item-content">
                                      <?php if (isset($sp["precio"])) { ?>
                                      <div class="item-price">
                                        <?php if (isset($sp["precioOferta"])) { ?>
                                        <div class="price-box">
                                          <p class="special-price"> <span class="price-label">Precio Oferta</span> <span class="price"> <?php echo "$".number_format(0,$sp["precioOferta"],",","."); ?> </span> </p>
                                          <p class="old-price"> <span class="price-label">Precio Normal</span> <span class="price"> <?php echo "$".number_format(0,$sp["precio"],",","."); ?> </span> </p>
                                        </div>
                                        <?php } ?>
                                        <?php if (empty($sp["precioOferta"])) { ?>
                                        <div class="price-box">
                                          <p class="special-price"> <span class="price-label">Precio</span> <span class="price"> <?php echo "$".number_format(0,$sp["precio"],",","."); ?> </span> </p>
                                        </div>
                                        <?php } ?>
                                      </div>
                                      <?php } ?>
                                      <div class="pro-action">
                                        <button type="button" class="add-to-cart" onClick="location.href='../productos/<?php echo $sp["nombreSEO"]; ?>'"><span> Ver Producto</span> </button>
                                      </div>
                                    </div>
                                  </div>
                                </div>
			...
			<?php } while ($row_familiasSelect = mysqli_fetch_assoc($familiasSelect)); ?>
            <?php } ?>
          </div>
        </div>
