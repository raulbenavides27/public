...
$query_productosShow = "SELECT * FROM productos WHERE productos.estado = '1' ORDER BY productos.id ASC";
...
<title><?php echo $row_metaDatos["titulo"]." | Catálogo de Productos"; ?></title>
<!-- InstanceEndEditable -->
            ...
            <div class="slider-items-products">
              <div id="category-desc-slider" class="product-flexslider hidden-buttons">
                <div class="slider-items slider-width-col1 owl-carousel owl-Template"> 
                  ...
                  <!-- head -->
                  <div class="item"> <a href="#"><img alt="<?php echo "Cat&aacute;logo de Productos | ".$row_metaDatos["titulo"]; ?>" src="../images/catalogo/bg_catalogo.jpg"></a>
                    <div class="inner-info">
                      <div class="cat-img-title"> <span>Cat&aacute;logo de Productos</span>
                        <h2 class="cat-heading">Todos nuestros productos</h2>
                        <p>Descubre nuestro extenso cat&aacute;logo de productos para todas tus necesidades</p>
