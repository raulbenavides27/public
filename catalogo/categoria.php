...
$query_productosShow = "SELECT * FROM productos WHERE productos.estado = '1' AND productos.categoriaSEO = '$categoria' ORDER BY productos.id ASC";
...
//actualizar visita
  $updateSQL = sprintf("UPDATE menuCategorias SET menuCategorias.visitas = menuCategorias.visitas +1 WHERE menuCategorias.categoriaSEO = '$categoria' AND menuCategorias.estado = '1'");
...
<title><?php echo $row_metaDatos["titulo"]." | ".$row_categoriaSelect["categoria"]." | Catálogo de Productos"; ?></title>
<!-- InstanceEndEditable -->
...
if (screen.width<500) {
window.location="http://mobile.prodalum.cl/home/#!/../catalogo/categoria.php?categoria=<?php echo $row_categoriaSelect["categoriaSEO"]; ?>";
}
</script>-->
      ...
      <div class="row">
        <div class="col-xs-12">
          <ul>
            ...
            <li><strong><?php echo $row_categoriaSelect["categoria"]; ?></strong></li>
          </ul>
        </div>
      </div>
    </div>
            ...
            <div class="slider-items-products">
              <div id="category-desc-slider" class="product-flexslider hidden-buttons">
                <div class="slider-items slider-width-col1 owl-carousel owl-Template"> 
                  ...
                  <!-- head
                  <div class="item"> <a href="#"><img alt="<?php echo "Cat&aacute;logo de Productos | ".$row_metaDatos["titulo"]; ?>" src="../images/catalogo/<?php echo $row_categoriaSelect["imagen"]; ?>"></a>
                    <div class="inner-info">
                      <div class="cat-img-title"> <span><?php echo $row_categoriaSelect["categoria"]; ?></span>
                        <h2 class="cat-heading"><?php echo $row_categoriaSelect["titulo"]; ?></h2>
                        <p><?php echo $row_categoriaSelect["bajada"]; ?></p>
                        <a class="info" href="../catalogo">Ver Video</a>
                      </div>
                    </div>
                  </div>
                  END head --> 
                  ...
                  <div class="item"> <a href="#"><img alt="<?php echo "Cat&aacute;logo de Productos | ".$row_metaDatos["titulo"]; ?>" src="../images/catalogo/<?php echo $row_categoriaSelect["imagen"]; ?>"></a>
                    <div class="inner-info">
                      <div class="cat-img-title"> <span><?php echo $row_categoriaSelect["categoria"]; ?></span>
                        <h2 class="cat-heading"><?php echo $row_categoriaSelect["titulo"]; ?></h2>
                        <p><?php echo $row_categoriaSelect["bajada"]; ?></p>
                        <a class="info" data-toggle="modal" data-target="#videoModal">Ver Video</a>
                      </div>
                    </div>
                  </div>
                  <!-- END head --> 
              ...
              <ul class="products-grid">
                        ...
                        <div class="item-info">
                          <div class="info-inner">
                            ...
                            <div class="item-content">
                              ...
                              <?php } ?>
                              <div class="pro-action">
                                <button type="button" class="add-to-cart" onClick="location.href='../productos/<?php echo $row_productosShow["nombreSEO"]; ?>'"><span> Ver L&iacute;nea</span> </button>
                              </div>
                            </div>
                          </div>
                        </div>
                ...
                <?php } ?>
                  <!-- <li class="col-lg-12 a-center">
                  	<div class='embed-container a-center'>
                    	<iframe src="https://player.vimeo.com/video/272786898" width="75%" height="360" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
                    </div>
                  </li> -->
      ...
      <div class="modal-content">
        <div class="modal-body">
          <div class="col-lg-12 a-center">
          	<div class='embed-container a-center'>
           	  <iframe src="https://player.vimeo.com/video/272786898" width="100%" height="460" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
            </div>
          </div>
        </div>
      </div>
