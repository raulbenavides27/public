...
$query_valorSelect = sprintf("SELECT * FROM escalasEtiquetas WHERE escalasEtiquetas.etiquetaSEO = '$etiqueta'");
...
$etiqueta = $row_valorSelect["etiquetaSEO"];
...
$query_productosShow = "SELECT * FROM productos WHERE productos.estado = '1' AND productos.categoriaSEO = 'escalas' AND productos.etiqueta = '$etiqueta' ORDER BY productos.id ASC";
...
<title><?php echo $row_metaDatos["titulo"]." | ".$row_categoriaSelect["categoria"]." | Etiqueta ".$row_valorSelect["etiqueta"]; ?></title>
<!-- InstanceEndEditable -->
      ...
      <div class="row">
        <div class="col-xs-12">
          <ul>
            ...
            <li><strong><?php echo "Etiqueta ".ucwords($row_valorSelect["etiqueta"]); ?></strong></li>
          </ul>
        </div>
      </div>
    </div>
        ...
        <div class="col-main col-sm-9 col-xs-12 col-sm-push-3">
          ...
          <div class="shop-inner">
            <div class="page-title">
              <h2><?php echo $row_categoriaSelect["categoria"]; ?> / Etiqueta <?php echo ucwords($row_valorSelect["etiqueta"]); ?></h2>
            </div>
            <div class="toolbar">
              <!-- <div class="view-mode">
                <ul>
