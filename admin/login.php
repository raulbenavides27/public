                    ...
                    <div class="row">
                        <div class="col-sm-8 col-sm-offset-2 text">
                            ...
                            <div class="description">
                            	<p>Ingresa con tu correo y contraseña. Si tienes alguna duda, olvidaste tus credenciales o quieres demostrarme tu amor escríbeme a <a href="mailto:hola@diegokingkong.com"><strong>hola@diegokingkong.com</strong></a>.</p>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                            ...
                            <div class="form-bottom">
			                    <form role="form" action="<?php echo $loginFormAction; ?>" method="POST" name="ingreso" class="login-form">
			                    	<div class="form-group">
			                        	...
			                        	<input type="text" name="correo" placeholder="correo@electronico.com" class="form-username form-control" id="form-username">
			                        </div>
			                        <div class="form-group">
