                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td class="text-center">
                                            <a class="font-" href="qts_clientes-view.php?id=<?php echo $row_clientes["id"]; ?>">
                                        ...
                                        <td class="visible-lg">
                                            <a href="qts_clientes-view.php?id=<?php echo $row_clientes["id"]; ?>"><?php if (isset($row_clientes["razonSocial"])) echo $row_clientes["razonSocial"]; else echo $row_clientes["nombre"]." ".$row_clientes["apellido"]; ?></a>
                                        </td>
                                        ...
                                        <td class="text-center">
                                            <div class="btn-group btn-group-xs">
                                                <a href="qts_clientes-view.php?id=<?php echo $row_clientes["id"]; ?>" data-toggle="tooltip" title="Ver" class="btn btn-default"><i class="fa fa-eye"></i></a>
                                                <a href="qts_clientes-remove.php?id=<?php echo $row_clientes["id"]; ?>" data-toggle="tooltip" title="Eliminar" class="btn btn-default"><i class="fa fa-times text-danger"></i></a>
                                            </div>
                                        </td>
                                    </tr>
                        ...
                        <div class="block-content">
                            <table class="table table-borderless table-striped table-vcenter js-dataTable-full">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td class="text-center">
                                            <a class="font-" href="qts_clientes-view.php?id=<?php echo $row_clientesAgente["id"]; ?>">
                                        ...
                                        <td class="visible-lg">
                                            <a href="qts_clientes-view.php?id=<?php echo $row_clientesAgente["id"]; ?>"><?php if (isset($row_clientesAgente["razonSocial"])) echo $row_clientesAgente["razonSocial"]; else echo $row_clientesAgente["nombre"]." ".$row_clientesAgente["apellido"]; ?></a>
                                        </td>
                                        ...
                                        <td class="text-center">
                                            <div class="btn-group btn-group-xs">
                                                <a href="qts_clientes-view.php?id=<?php echo $row_clientesAgente["id"]; ?>" data-toggle="tooltip" title="Ver" class="btn btn-default"><i class="fa fa-eye"></i></a>
                                                <a href="qts_clientes-remove.php?id=<?php echo $row_clientesAgente["id"]; ?>" data-toggle="tooltip" title="Eliminar" class="btn btn-default"><i class="fa fa-times text-danger"></i></a>
                                            </div>
                                        </td>
                                    </tr>
