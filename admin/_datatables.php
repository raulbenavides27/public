    ...
    <body>
        ...
        <div id="page-container" class="sidebar-l sidebar-o side-scroll header-navbar-fixed">
            ...
            <main id="main-container">
                ...
                <script>
                function upload($DKKadmin)
                {
                    self.name = 'opener';
                    remote = open('up/homeSlider.php', 'remote', 'width=410,height=200,location=no,scrollbar=no,menubars=no,toolbars=no,resizable=no,fullscreen=no, status=yes');
                    ...
                    <div class="row items-push">
                        <div class="col-sm-7">
                            <h1 class="page-heading">
                                Home Slider <small>Estas son las im&aacute;genes del slider inicial.</small>
                            </h1>
                        </div>
                        <div class="col-sm-5 text-right hidden-xs">
                            <ol class="breadcrumb push-10-t">
                                <li>Dashboard</li>
                                <li><a class="link-effect" href="">Home Slider</a></li>
                            </ol>
                        </div>
                    </div>
                </div>
                ...
                <div class="content">
                    <div class="row">
                        <div class="col-lg-8">
                            ...
                            <div class="row">
                               <div class="col-sm-6 col-md-3">
                                    <a class="block block-link-hover3 text-center" href="blog-add.php">
                                        <div class="block-content block-content-full">
                                            <div class="h1 font-w700 text-success"><i class="fa fa-plus"></i></div>
                                        </div>
                                        <div class="block-content block-content-full block-content-mini bg-gray-lighter text-success font-w600">Nuevo Post</div>
                                    </a>
                                </div>
                                <div class="col-sm-6 col-md-3">
                                    <a class="block block-link-hover3 text-center" href="javascript:void(0)">
                                        <div class="block-content block-content-full">
                                            <div class="h1 font-w700 text-warning" data-toggle="countTo" data-to="<?php echo $totalRows_blogInactivos; ?>"></div>
                                        </div>
                                        <div class="block-content block-content-full block-content-mini bg-gray-lighter text-warning font-w600">Inactivos</div>
                                    </a>
                                </div>
                                <div class="col-sm-6 col-md-3">
                                    <a class="block block-link-hover3 text-center" href="javascript:void(0)">
                                        <div class="block-content block-content-full">
                                            <div class="h1 font-w700" data-toggle="countTo" data-to="<?php echo $totalRows_blogActivos; ?>"></div>
                                        </div>
                                        <div class="block-content block-content-full block-content-mini bg-gray-lighter text-muted font-w600">Activos</div>
                                    </a>
                                </div>
                                <div class="col-sm-6 col-md-3">
                                    <a class="block block-link-hover3 text-center" href="javascript:void(0)">
                                        <div class="block-content block-content-full">
                                            <div class="h1 font-w700" data-toggle="countTo" data-to="<?php echo $totalRows_blogLista; ?>"></div>
                                        </div>
                                        <div class="block-content block-content-full block-content-mini bg-gray-lighter text-muted font-w600">Total Posts</div>
                                    </a>
                                </div>
                            </div>
                            <!-- END header -->
                            ...
                            <div class="block">
                                <div class="block-header">
                                    <h3 class="block-title">Posts <small>Todos</small></h3>
                                </div>
                                <div class="block-content">
                                    ...
                                    <table class="table table-bordered table-striped js-dataTable-full">
                                        ...
                                        <tbody>
                                            <?php do { ?>
                                            <tr>
                                                <td class="text-center"><?php echo $row_blogLista["id"]; ?></td>
                                                <td class="font-w600"><?php echo $row_blogLista["titulo"]; ?></td>
                                                <td class="hidden-xs"><?php echo strtoupper(str_replace("-"," ",$row_blogLista["categoriaSEO"])); ?></td>
                                                <td class="hidden-xs">
                                                  <span class="label label-<?php if ($row_blogLista["estado"] == '1') {echo"success";}; if ($row_blogLista["estado"] == '2') {echo"warning";};if ($row_blogLista["estado"] == '3') {echo"danger";};  ?>"><?php if ($row_blogLista["estado"] == '1') {echo"ACTIVO";}; if ($row_blogLista["estado"] == '2') {echo"INACTIVO";};if ($row_blogLista["estado"] == '3') {echo"ELIMINADO";};  ?></span>
                                                </td>
                                                <td class="text-center">
                                                  <div class="btn-group">
                                                    <button class="btn btn-xs btn-default" type="button" data-toggle="tooltip" title="Editar Post" onClick="location.href='blog-edit.php?id=<?php echo $row_blogLista["id"]; ?>'"><i class="fa fa-pencil"></i></button>
                                                    <button class="btn btn-xs btn-default" type="button" data-toggle="tooltip" title="Eliminar Post" onClick="location.href='blog-remove.php?id=<?php echo $row_blogLista["id"]; ?>'"><i class="fa fa-times"></i></button>
                                                    </div>
                                                </td>
                                              </tr>
                                              <?php } while ($row_blogLista = mysqli_fetch_assoc($blogLista)); ?>
                                        </tbody>
                                    </table>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-4">
                            <div class="block">
                                <div class="block-header">
                                    <h3 class="block-title">Nueva Categor&iacute;a</h3>
                                </div>
                                <div class="block-content block-content-narrow">
                                    <form method="POST" action="<?php echo $editFormAction; ?>" class="form-horizontal push-10-t" name="nuevaCategoria">
                                        <div class="form-group">
                                            <div class="col-sm-12">
                                                <div class="form-material">
                                                    <input class="form-control" type="text" id="titulo" name="titulo" placeholder="Ingresa el Nombre de la Categor&iacute;a">
                                                    <label for="titulo">Ingresa el Nombre de la Categor&iacute;a</label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="col-sm-12">
                                                <div class="form-material">
                                                    <input class="form-control" type="text" id="tituloSEO" name="tituloSEO" placeholder="Ingresa el SEO de la Categor&iacute;a">
                                                    <label for="tituloSEO">Ingresa el SEO de la Categor&iacute;a</label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="col-xs-12">
                                                <div class="form-material">
                                                    <textarea class="form-control" id="bajada" name="bajada" rows="3" placeholder="Agrega una peque&ntilde;a decripci&oacute;n de la categor&iacute;a"></textarea>
										...
										<div class="form-group">
                                            <div class="col-xs-12">
                                                <div class="form-material input-group">
                                                    <input class="form-control" type="text" id="imagen" name="imagen" placeholder="Selecciona la imagen" required>
                                                    <label for="imagen">Imagen (1680x1100px)</label>
                                                    <span class="input-group-addon"><a href="javascript:upload($DKKadmin);"><i class="fa fa-search"></i></a></span>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="col-xs-12">
                                                <label class="css-input switch switch-sm switch-success">
                                                    <input type="checkbox" id="estado" name="estado" checked="checked"><span></span> ¿Quieres activarla?
                                                </label>
                                            </div>
                                        </div>
                                        ...
                                        <input type="hidden" name="MM_insert" value="nuevaCategoria">
                                    </form>
                                </div>
                            </div>
