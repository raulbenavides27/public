...
$query_ConsultaChange = sprintf("SELECT * FROM menuCategorias WHERE menuCategorias.id = '$idCategoria'");
...
<?php
//Actualizar Estado
  $updateSQL = sprintf("UPDATE menuCategorias SET menuCategorias.estado = '0' WHERE menuCategorias.id = '$idCategoria'");
