...
<?php if ((isset($_POST["enviado"])) && ($_POST["enviado"] == "noticiasForm")) {
	$nombre_archivo = $_FILES['userfile']['name']; 
	move_uploaded_file($_FILES['userfile']['tmp_name'], "../../images/noticias/".$nombre_archivo);
	
	?>
    <script>
		opener.document.noticiasForm.imagen.value="<?php echo $nombre_archivo; ?>";
		self.close();
	</script>
    <?php
}
        	...
        	<div class="content content-boxed">
                <div class="block">
                	<div class="block-content block-content-full">
                            <div class="row">
                                <div class="col-sm-12">
                            	<form action="noticias.php" method="post" enctype="multipart/form-data" id="noticiasForm">
                                	...
                                	<div class="form-group">
                                        <div class="col-xs-12" style="margin-top:20px;">                                            
                                            ...
                                            <input type="hidden" name="enviado" value="noticiasForm" />
                                        </div>
                                    </div>
                                </form>
                                </div>
