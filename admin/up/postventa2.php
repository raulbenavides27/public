...
<?php if ((isset($_POST["enviado"])) && ($_POST["enviado"] == "postVentaForm")) {
	...
	?>
    <script>
		opener.document.postVentaForm.imagen2.value="<?php echo $nombre_archivo; ?>";
		self.close();
	</script>
    <?php
}
        	...
        	<div class="content content-boxed">
                <div class="block">
                	<div class="block-content block-content-full">
                            <div class="row">
                                <div class="col-sm-12">
                            	<form action="postventa2.php" method="post" enctype="multipart/form-data" id="postVentaForm">
