...
<?php if ((isset($_POST["enviado"])) && ($_POST["enviado"] == "subCategoriasForm")) {
	$nombre_archivo = $_FILES['userfile']['name']; 
	move_uploaded_file($_FILES['userfile']['tmp_name'], "../../uploads/".$nombre_archivo);
	
	?>
    <script>
		opener.document.subCategoriasForm.imagen.value="<?php echo $nombre_archivo; ?>";
		self.close();
	</script>
    <?php
}
        	...
        	<div class="content content-boxed">
                <div class="block">
                	<div class="block-content block-content-full">
                            <div class="row">
                                <div class="col-sm-12">
                            	<form action="subcategorias.php" method="post" enctype="multipart/form-data" id="subCategoriasForm">
                                	...
                                	<div class="form-group">
                                        <div class="col-xs-12" style="margin-top:20px;">                                            
                                            ...
                                            <input type="hidden" name="enviado" value="subCategoriasForm" />
                                        </div>
                                    </div>
                                </form>
                                </div>
