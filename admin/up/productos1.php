...
<?php if ((isset($_POST["enviado"])) && ($_POST["enviado"] == "productoForm")) {
	$nombre_archivo = $_FILES['userfile']['name']; 
	move_uploaded_file($_FILES['userfile']['tmp_name'], "../../images/productos/".$nombre_archivo);
	
	?>
    <script>
		opener.document.productoForm.imagen1.value="<?php echo $nombre_archivo; ?>";
		self.close();
	</script>
    <?php
}
        	...
        	<div class="content content-boxed">
                <div class="block">
                	<div class="block-content block-content-full">
                            <div class="row">
                                <div class="col-sm-12">
                            	<form action="productos1.php" method="post" enctype="multipart/form-data" id="productoForm">
                                	...
                                	<div class="form-group">
                                        <div class="col-xs-12" style="margin-top:20px;">                                            <button class="btn btn-block btn-primary push-10" type="submit"><i class="fa fa-upload"></i> Cargar</button>
                                            <input type="hidden" name="enviado" value="productoForm" />
                                        </div>
                                    </div>
                                </form>
                                </div>
