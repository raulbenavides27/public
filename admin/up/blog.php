...
<?php if ((isset($_POST["enviado"])) && ($_POST["enviado"] == "blogForm")) {
	$nombre_archivo = $_FILES['userfile']['name']; 
	move_uploaded_file($_FILES['userfile']['tmp_name'], "../../images/blog/".$nombre_archivo);
	
	?>
    <script>
		opener.document.blogForm.imagen.value="<?php echo $nombre_archivo; ?>";
		self.close();
	</script>
    <?php
}
        	...
        	<div class="content content-boxed">
                <div class="block">
                	<div class="block-content block-content-full">
                            <div class="row">
                                <div class="col-sm-12">
                            	<form action="blog.php" method="post" enctype="multipart/form-data" id="blogForm">
                                	...
                                	<div class="form-group">
                                        <div class="col-xs-12" style="margin-top:20px;">                                            
                                            ...
                                            <input type="hidden" name="enviado" value="blogForm" />
                                        </div>
                                    </div>
                                </form>
                                </div>
