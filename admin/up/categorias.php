...
<?php if ((isset($_POST["enviado"])) && ($_POST["enviado"] == "categoriasForm")) {
	$nombre_archivo = $_FILES['userfile']['name']; 
	move_uploaded_file($_FILES['userfile']['tmp_name'], "../../uploads/".$nombre_archivo);
	
	?>
    <script>
		opener.document.categoriasForm.imagen.value="<?php echo $nombre_archivo; ?>";
		self.close();
	</script>
    <?php
}
        	...
        	<div class="content content-boxed">
                <div class="block">
                	<div class="block-content block-content-full">
                            <div class="row">
                                <div class="col-sm-12">
                            	<form action="categorias.php" method="post" enctype="multipart/form-data" id="categoriasForm">
                                	...
                                	<div class="form-group">
                                        <div class="col-xs-12" style="margin-top:20px;">                                            
                                            ...
                                            <input type="hidden" name="enviado" value="categoriasForm" />
                                        </div>
                                    </div>
                                </form>
                                </div>
