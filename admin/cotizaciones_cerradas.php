...
$query_cotizacionesShow = "SELECT * FROM cotizaciones WHERE cotizaciones.estado = '3' ORDER BY cotizaciones.id DESC";
...
$query_cotizacionesShowTodos = "SELECT * FROM cotizaciones WHERE cotizaciones.estado = '3' ORDER BY cotizaciones.id DESC";
