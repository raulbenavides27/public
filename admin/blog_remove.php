...
;
$query_ConsultaChange = sprintf("SELECT * FROM blog WHERE blog.id = %s", GetSQLValueString($varID_ConsultaChange, "int"));
...
<?php
//Actualizar Estado
  $updateSQL = sprintf("UPDATE blog SET blog.estado = '0' WHERE blog.id = %s",GetSQLValueString($varID_ConsultaChange, "int"));
