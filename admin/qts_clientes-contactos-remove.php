...
$query_ConsultaChange = sprintf("SELECT * FROM qts_clientesContactos WHERE qts_clientesContactos.id = %s", GetSQLValueString($varID_ConsultaChange, "int"));
...
//Actualizar Estado
  $updateSQL = sprintf("UPDATE qts_clientesContactos SET qts_clientesContactos.estado = '0' WHERE qts_clientesContactos.id = %s",GetSQLValueString($varID_ConsultaChange, "int"));
