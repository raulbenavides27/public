...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "representantesForm")) {
  $updateSQL = sprintf("UPDATE representantes SET imagen=%s, nombre=%s, nombreSEO=%s, pais=%s, direccion=%s, telefono=%s, link=%s, estado=%s WHERE id=%s",
...
$representantes = mysqli_query($DKKadmin, $query_representantes) or die(mysqli_error($DKKadmin));
$row_representantes = mysqli_fetch_assoc($representantes);
$totalRows_representantes = mysqli_num_rows($representantes);

$query_representantesEdit = "SELECT * FROM representantes WHERE representantes.id = '$getID' ORDER BY representantes.id ASC";
$representantesEdit = mysqli_query($DKKadmin, $query_representantesEdit) or die(mysqli_error($DKKadmin));
$row_representantesEdit = mysqli_fetch_assoc($representantesEdit);
$totalRows_representantesEdit = mysqli_num_rows($representantesEdit);
?>
<!DOCTYPE html>
    ...
    <body>
        ...
        <div id="page-container" class="sidebar-l sidebar-o side-scroll header-navbar-fixed">
            ...
            <main id="main-container">
                ...
                {
                    self.name = 'opener';
                    remote = open('up/representantes.php', 'remote', 'width=410,height=200,location=no,scrollbar=no,menubars=no,toolbars=no,resizable=no,fullscreen=no, status=yes');
                    remote.focus($DKKadmin);
                    }	
                </script>
                <!-- fin script -->
                <!-- header -->
                    ...
                    <div class="row items-push">
                        <div class="col-sm-7">
                            <h1 class="page-heading">
                                Representantes <small>Estos son nuestros socios estrat&eacute;gicos por el mundo.</small>
                            </h1>
                        </div>
                        <div class="col-sm-5 text-right hidden-xs">
                            <ol class="breadcrumb push-10-t">
                                <li>Dashboard</li>
                                <li><a class="link-effect" href="">Representantes</a></li>
                            </ol>
                        </div>
                    </div>
                </div>
                ...
                <div class="content">
                    <div class="row">
                        <div class="col-lg-8">
                            ...
                            <div class="block">
                                <div class="block-header">
                                    <h3 class="block-title">Representantes <small>Todos</small></h3>
                                </div>
                                    ...
                                    <table class="table table-bordered table-striped js-dataTable-full">
                                        <thead>
                                            <tr>
                                                ...
                                                <th>Nombre</th>
                                                <th class="hidden-xs">Pa&iacute;s</th>
                                        ...
                                        <tbody>
                                            <?php do { ?>
                                            <tr>
                                                <td class="text-center"><?php echo $row_representantes["id"]; ?></td>
                                                <td class="font-w600"><?php echo $row_representantes["nombre"]; ?></td>
                                                <td class="hidden-xs"><?php echo strtoupper(str_replace("-"," ",$row_representantes["pais"])); ?></td>
                                                <td class="hidden-xs">
                                                  <span class="label label-<?php if ($row_representantes["estado"] == '1') {echo"success";}; if ($row_representantes["estado"] == '2') {echo"warning";};if ($row_representantes["estado"] == '3') {echo"danger";};  ?>"><?php if ($row_representantes["estado"] == '1') {echo"ACTIVO";}; if ($row_representantes["estado"] == '2') {echo"INACTIVO";};if ($row_representantes["estado"] == '3') {echo"ELIMINADO";};  ?></span>
                                                </td>
                                                <td class="text-center">
                                                  <div class="btn-group">
                                                    <button class="btn btn-xs btn-default" type="button" data-toggle="tooltip" title="Editar Representante" onClick="location.href='representantes_edit.php?id=<?php echo $row_representantes["id"]; ?>'"><i class="fa fa-pencil"></i></button>
                                                    <button class="btn btn-xs btn-default" type="button" data-toggle="tooltip" title="Eliminar Representante" onClick="location.href='representantes_remove.php?id=<?php echo $row_representantes["id"]; ?>'"><i class="fa fa-times"></i></button>
                                                    </div>
                                                </td>
                                              </tr>
                        ...
                        <div class="col-lg-4">
                            <div class="block">
                                <div class="block-header">
                                    <h3 class="block-title">Nuevo Representante</h3>
                                </div>
                                <div class="block-content block-content-narrow">
                                    <form method="POST" action="<?php echo $editFormAction; ?>" class="form-horizontal push-10-t" name="representantesForm">
                                        <div class="form-group">
                                            <div class="col-sm-12">
                                                <div class="form-material">
                                                    <input class="form-control" type="text" id="nombre" name="nombre" placeholder="Ingresa el Nombre del Representante" value="<?php echo $row_representantesEdit["nombre"]; ?>">
                                                    <label for="nombre">Ingresa el Nombre del Representante</label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="col-sm-12">
                                                <div class="form-material">
                                                    <input class="form-control" type="text" id="nombreSEO" name="nombreSEO" placeholder="Ingresa el SEO del Representante" value="<?php echo $row_representantesEdit["nombreSEO"]; ?>">
                                                    <label for="nombreSEO">Ingresa el SEO del Representante</label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="col-sm-12">
                                                <div class="form-material">
                                                    <input class="form-control" type="text" id="pais" name="pais" placeholder="Ingresa su pa&iacute;s" value="<?php echo $row_representantesEdit["pais"]; ?>">
                                                    <label for="pais">Ingresa su pa&iacute;s</label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="col-sm-12">
                                                <div class="form-material">
                                                    <input class="form-control" type="text" id="telefono" name="telefono" placeholder="Ingresa el tel&eacute;fono" value="<?php echo $row_representantesEdit["telefono"]; ?>">
                                                    <label for="telefono">Ingresa el tel&eacute;fono</label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="col-xs-12">
                                                <div class="form-material">
                                                    <textarea class="form-control" id="direccion" name="direccion" rows="3" placeholder="Ingresa la direcci&oacute;n del representante"><?php echo $row_representantesEdit["direccion"]; ?></textarea>
                                        ...
                                        <div class="form-group">
                                            <div class="col-sm-12">
                                                <div class="form-material">
                                                    <input class="form-control" type="text" id="link" name="link" placeholder="Ingresa el link web del Representante" value="<?php echo $row_representantesEdit["link"]; ?>">
                                                    <label for="link">Ingresa el tel&eacute;fono</label>
                                                </div>
                                            </div>
                                        </div>
										<div class="form-group">
                                            <div class="col-xs-12">
                                                <div class="form-material input-group">
                                                    <input class="form-control" type="text" id="imagen" name="imagen" placeholder="Selecciona la imagen (525x380 px)" required value="<?php echo $row_representantesEdit["imagen"]; ?>">
                                                    <label for="imagen">Imagen (525x380 px)</label>
                                                    <span class="input-group-addon"><a href="javascript:upload();"><i class="fa fa-search"></i></a></span>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="col-xs-12">
                                                <label class="css-input switch switch-sm switch-success">
                                                    <input type="checkbox" id="estado" name="estado" <?php if ($row_representantesEdit["estado"] == '1') {echo"checked";}?>><span></span> ¿Quieres activarlo?
                                                </label>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <div class="col-md-12">
                                                ...
                                                <input type="hidden" name="id" value="<?php echo $row_representantesEdit["id"]; ?>">
                                            </div>
                                        </div>
                                        <input type="hidden" name="MM_insert" value="representantesForm">
                                    </form>
                                </div>
                            </div>
...
mysqli_free_result($representantes);

mysqli_free_result($representantesEdit);
?>
