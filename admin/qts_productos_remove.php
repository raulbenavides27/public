...
$query_ConsultaChange = sprintf("SELECT * FROM qts_cotizacionesProductos WHERE qts_cotizacionesProductos.id = %s", GetSQLValueString($varID_ConsultaChange, "int"));
...
//Actualizar Estado
  $updateSQL = sprintf("UPDATE qts_cotizacionesProductos SET qts_cotizacionesProductos.estado = '0' WHERE qts_cotizacionesProductos.id = %s",GetSQLValueString($varID_ConsultaChange, "int"));
