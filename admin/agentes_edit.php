...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "agenteForm")) {
  $updateSQL = sprintf("UPDATE `admin` SET nombre=%s, apellido=%s, correo=%s, password=%s, nivel=%s, estado=%s WHERE id=%s",
...
$varIDadminEditar_agentesEdit = "0";
if (isset($_GET["id"])) {
  $varIDadminEditar_agentesEdit = $_GET["id"];
}
$query_agentesEdit = sprintf("SELECT * FROM `admin` WHERE `admin`.id = %s", GetSQLValueString($varIDadminEditar_agentesEdit, "int"));
$agentesEdit = mysqli_query($DKKadmin, $query_agentesEdit);
$row_agentesEdit = mysqli_fetch_assoc($agentesEdit);
$totalRows_agentesEdit = mysqli_num_rows($agentesEdit);
?>
<!DOCTYPE html>
                ...
                <div class="content">
                    <div class="row">
                                    ...
                                    <table class="table table-bordered table-striped js-dataTable-full">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                  <div class="btn-group">
                                                    <button class="btn btn-xs btn-default" type="button" data-toggle="tooltip" title="Editar Agente" onClick="location.href='agentes_edit.php?id=<?php echo $row_agentesTotal["id"]; ?>'"><i class="fa fa-pencil"></i></button>
                                                    <?php if ($row_agentesTotal["estado"] != '0') { ?>
                                                    <button class="btn btn-xs btn-default" type="button" data-toggle="tooltip" title="Eliminar Agente" onClick="location.href='agentes_remove.php?id=<?php echo $row_agentesTotal["id"]; ?>'"><i class="fa fa-times"></i></button>
                                                    <?php } ?>
                                                    <?php if ($row_agentesTotal["estado"] == '0') { ?>
                                                    <button class="btn btn-xs btn-default" type="button" data-toggle="tooltip" title="Eliminar Agente" onClick="location.href='agentes_delete.php?id=<?php echo $row_agentesTotal["id"]; ?>'"><i class="fa fa-trash text-danger"></i></button>
                                                    <?php } ?>
                                                    </div>
                                                </td>
                                            </tr>
                        ...
                        <!-- Nuevo Agente -->
                            <div class="block">
                                <div class="block-header">
                                    <h3 class="block-title">Editar Agente</h3>
                                </div>
                                <div class="block-content">
                                    <form method="POST" action="<?php echo $editFormAction; ?>" class="form-horizontal push-10-t push-10" name="agenteForm">
                                        <div class="form-group">
                                            <div class="col-xs-6">
                                                <div class="form-material">
                                                    <input class="form-control" type="text" id="nombre" name="nombre" placeholder="Ingresa el Nombre" value="<?php echo $row_agentesEdit["nombre"]; ?>">
                                                    <label for="nombre">Nombre</label>
                                                </div>
                                            </div>
                                            <div class="col-xs-6">
                                               <div class="form-material">
                                                    <input class="form-control" type="text" id="apellido" name="apellido" placeholder="Ingresa el Apellido" value="<?php echo $row_agentesEdit["apellido"]; ?>">
                                        ...
                                        <div class="form-group">
                                            <div class="col-xs-12">
                                                <div class="form-material input-group">
                                                    <input class="form-control" type="email" id="correo" name="correo" placeholder="Correo del Agente" value="<?php echo $row_agentesEdit["correo"]; ?>">
                                        ...
                                        <div class="form-group">
                                            <div class="col-xs-12">
                                                <div class="form-material input-group">
                                                    <input class="form-control" type="password" id="passwordValidar" name="passwordValidar" placeholder="Ingresa una Contraseña" value="<?php echo $row_agentesEdit["password"]; ?>">
                                        ...
                                        <div class="form-group">
                                            <div class="col-xs-12">
                                                <div class="form-material input-group">
                                                    <input class="form-control" type="password" id="password" name="password" placeholder="Confirma la Contraseña" value="<?php echo $row_agentesEdit["password"]; ?>">
                                        ...
                                        <div class="form-group">
                                            <div class="col-xs-12">
                                                <label class="css-input css-checkbox css-checkbox-primary">
                                                    <input <?php if (!(strcmp($row_agentesEdit['nivel'],1))) {echo "checked=\"checked\"";} ?> type="checkbox" id="nivel" name="nivel"><span></span> Super Administrador
                                                </label>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="col-xs-12">
                                                <label class="css-input css-checkbox css-checkbox-primary">
                                                    <input <?php if (!(strcmp($row_agentesEdit['estado'],1))) {echo "checked=\"checked\"";} ?> type="checkbox" id="estado" name="estado"><span></span> Activar Agente
                                                </label>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="col-xs-12">
                                                <button class="btn btn-sm btn-primary" type="submit"><i class="fa fa-save push-5-r"></i> Guardar</button>
                                                <input type="hidden" name="id" value="<?php echo $row_agentesEdit["id"]; ?>">
                                            </div>
                                        </div>
                                        <input type="hidden" name="MM_update" value="agenteForm">
                                    </form>
                                </div>
                            </div>
                            <!-- END Nuevo Agente -->
...
mysqli_free_result($agentesEdit);
?>
