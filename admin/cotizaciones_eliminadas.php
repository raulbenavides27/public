...
$query_cotizacionesShow = "SELECT * FROM cotizaciones WHERE cotizaciones.estado = '0' ORDER BY cotizaciones.id DESC";
...
$query_cotizacionesShowTodos = "SELECT * FROM cotizaciones WHERE cotizaciones.estado = '0' ORDER BY cotizaciones.id DESC";
                                            ...
                                            <tbody>
												...
												?>
                                                    ...
                                                    <td class="hidden-xs hidden-sm hidden-md text-center">
                                                        <a href="cotizaciones_delete.php?id=<?php echo $row_cotizacionesShow["id"]; ?>"><span class="badge badge-danger"><i class="fa fa-times"></i> </span></a>
                                                    </td>
                                                </tr>
                                                <?php } ?>
											    <?php } ?>
