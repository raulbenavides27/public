...
$query_productosTodos = "SELECT * FROM productos WHERE NOT productos.estado = '0' ORDER BY productos.id ASC";
$productosTodos = mysqli_query($DKKadmin, $query_productosTodos) or die(mysqli_error($DKKadmin));
$row_productosTodos = mysqli_fetch_assoc($productosTodos);
$totalRows_productosTodos = mysqli_num_rows($productosTodos);

$query_productosActivos = "SELECT * FROM productos WHERE productos.estado = '1' ORDER BY productos.id ASC";
$productosActivos = mysqli_query($DKKadmin, $query_productosActivos) or die(mysqli_error($DKKadmin));
$row_productosActivos = mysqli_fetch_assoc($productosActivos);
$totalRows_productosActivos = mysqli_num_rows($productosActivos);

$query_productosInactivos = "SELECT * FROM productos WHERE productos.estado = '2' ORDER BY productos.id ASC";
$productosInactivos = mysqli_query($DKKadmin, $query_productosInactivos) or die(mysqli_error($DKKadmin));
$row_productosInactivos = mysqli_fetch_assoc($productosInactivos);
$totalRows_productosInactivos = mysqli_num_rows($productosInactivos);
?>
<!DOCTYPE html>
                    ...
                    <div class="row items-push">
                        <div class="col-sm-7">
                            <h1 class="page-heading">
                                Productos <small>Estos son los productos de nuestra web.</small>
                            </h1>
                        </div>
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="row">
                               <div class="col-sm-6 col-md-3">
                                    <a class="block block-link-hover3 text-center" href="productos_add.php">
                                        <div class="block-content block-content-full">
                                            <div class="h1 font-w700 text-success"><i class="fa fa-plus"></i></div>
                                        </div>
                                        <div class="block-content block-content-full block-content-mini bg-gray-lighter text-success font-w600">Nuevo Producto</div>
                                    </a>
                                </div>
                                <div class="col-sm-6 col-md-3">
                                    <a class="block block-link-hover3 text-center" href="javascript:void(0)">
                                        <div class="block-content block-content-full">
                                            <div class="h1 font-w700 text-warning" data-toggle="countTo" data-to="<?php echo $totalRows_productosInactivos; ?>"></div>
                                        </div>
                                ...
                                <div class="col-sm-6 col-md-3">
                                    <a class="block block-link-hover3 text-center" href="javascript:void(0)">
                                        <div class="block-content block-content-full">
                                            <div class="h1 font-w700" data-toggle="countTo" data-to="<?php echo $totalRows_productosActivos; ?>"></div>
                                        </div>
                                ...
                                <div class="col-sm-6 col-md-3">
                                    <a class="block block-link-hover3 text-center" href="javascript:void(0)">
                                        <div class="block-content block-content-full">
                                            <div class="h1 font-w700" data-toggle="countTo" data-to="<?php echo $totalRows_productosTotal; ?>"></div>
                                        </div>
                            ...
                            <div class="block">
                                <div class="block-header">
                                    <h3 class="block-title">Productos <small>Todos</small></h3>
                                </div>
                                <div class="block-content">
                                    ...
                                    <table class="table table-bordered table-striped js-dataTable-full">
                                        ...
                                        <tbody>
                                            <?php do { ?>
                                            <tr>
                                                <td class="text-center"><?php echo $row_productosTodos["id"]; ?></td>
                                                <td class="font-w600"><?php echo $row_productosTodos["nombre"]; ?></td>
                                                <td class="hidden-xs"><?php echo strtoupper(str_replace("-"," ",$row_productosTodos["categoriaSEO"])); ?></td>
                                                <td class="hidden-xs"><?php echo $row_productosTodos["visitas"]; ?></td>
                                                <td class="hidden-xs">
                                                  <span class="label label-<?php if ($row_productosTodos["estado"] == '1') {echo"success";}; if ($row_productosTodos["estado"] == '2') {echo"warning";};if ($row_productosTodos["estado"] == '0') {echo"danger";};  ?>"><?php if ($row_productosTodos["estado"] == '1') {echo"ACTIVO";}; if ($row_productosTodos["estado"] == '2') {echo"INACTIVO";};if ($row_productosTodos["estado"] == '0') {echo"ELIMINADO";};  ?></span>
                                                </td>
                                                <td class="text-center">
                                                  <div class="btn-group">
                                                    <button class="btn btn-xs btn-default" type="button" data-toggle="tooltip" title="Editar Producto" onClick="location.href='productos_edit.php?id=<?php echo $row_productosTodos["id"]; ?>'"><i class="fa fa-pencil"></i></button>
                                                    <button class="btn btn-xs btn-default" type="button" data-toggle="tooltip" title="Eliminar Producto" onClick="location.href='productos_remove.php?id=<?php echo $row_productosTodos["id"]; ?>'"><i class="fa fa-times"></i></button>
                                                    </div>
                                                </td>
                                              </tr>
                                              <?php } while ($row_productosTodos = mysqli_fetch_assoc($productosTodos)); ?>
                                        </tbody>
                                    </table>
                                </div>
                            </div>
...
mysqli_free_result($productosTodos);

mysqli_free_result($productosActivos);

mysqli_free_result($productosInactivos);
?>
