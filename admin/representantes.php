...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "representantesForm")) {
  $insertSQL = sprintf("INSERT INTO representantes (imagen, nombre, nombreSEO, pais, direccion, telefono, link, estado) VALUES (%s, %s, %s, %s, %s, %s, %s, %s)",
                                ...
                                <div class="block-content block-content-narrow">
                                    <form method="POST" action="<?php echo $editFormAction; ?>" class="form-horizontal push-10-t" name="representantesForm">
                                        <div class="form-group">
                                            <div class="col-sm-12">
                                                <div class="form-material">
                                                    <input class="form-control" type="text" id="nombre" name="nombre" placeholder="Ingresa el Nombre del Representante">
                                        ...
                                        <div class="form-group">
                                            <div class="col-sm-12">
                                                <div class="form-material">
                                                    <input class="form-control" type="text" id="nombreSEO" name="nombreSEO" placeholder="Ingresa el SEO del Representante">
                                        ...
                                        <div class="form-group">
                                            <div class="col-sm-12">
                                                <div class="form-material">
                                                    <input class="form-control" type="text" id="pais" name="pais" placeholder="Ingresa su pa&iacute;s">
                                        ...
                                        <div class="form-group">
                                            <div class="col-sm-12">
                                                <div class="form-material">
                                                    <input class="form-control" type="text" id="telefono" name="telefono" placeholder="Ingresa el tel&eacute;fono">
                                        ...
                                        <div class="form-group">
                                            <div class="col-xs-12">
                                                <div class="form-material">
                                                    <textarea class="form-control" id="direccion" name="direccion" rows="3" placeholder="Ingresa la direcci&oacute;n del representante"></textarea>
                                        ...
                                        <div class="form-group">
                                            <div class="col-sm-12">
                                                <div class="form-material">
                                                    <input class="form-control" type="text" id="link" name="link" placeholder="Ingresa el link web del Representante">
										...
										<div class="form-group">
                                            <div class="col-xs-12">
                                                <div class="form-material input-group">
                                                    <input class="form-control" type="text" id="imagen" name="imagen" placeholder="Selecciona la imagen (525x380 px)" required>
                                        ...
                                        <div class="form-group">
                                            <div class="col-xs-12">
                                                <label class="css-input switch switch-sm switch-success">
                                                    <input type="checkbox" id="estado" name="estado" checked="checked"><span></span> ¿Quieres activarlo?
                                                </label>
                                            </div>
                                        </div>
