...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "noticiasForm")) {
  $insertSQL = sprintf("INSERT INTO noticias (titulo, tituloSEO, categoriaSEO, bajada, contenido, imagen, dia, mes, fecha, ip, creador, keywords, visitas, estado) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
                ...
                <div class="content content-boxed">
                    ...
                    <div class="block">
                        <div class="block-header bg-gray-lighter">
                            <h3 class="block-title">Nueva Noticia</h3>
                        </div>
                                ...
                                <div class="col-sm-8 col-sm-offset-2 col-lg-6 col-lg-offset-3">
                                    <form class="form-horizontal push-30-t push-30" name="noticiasForm" action="<?php echo $editFormAction; ?>" method="post">
                                        <div class="form-group">
                                            <div class="col-xs-12">
                                                <div class="form-material form-material-primary">
                                                    <input class="form-control" type="text" id="id" name="id" value="<?php echo $row_ultimaNoticia["id"] + 1; ?>" readonly >
                                        ...
                                        <div class="form-group">
                                            <div class="col-xs-12">
                                                <div class="form-material form-material-primary">
                                                    <input class="form-control" type="text" id="tituloSEO" name="tituloSEO">
                                            ...
                                            <div class="col-xs-12">
                                                <div class="form-material">
                                                    <select class="js-select2 form-control" id="categoriaSEO" name="categoriaSEO" style="width: 100%;" data-placeholder="Selecciona su categor&iacute;a..">
                                                        <option></option>
                                                        <?php do { ?>
                                                        <option value="<?php echo $row_categoriasNoticias["categoriaSEO"]; ?>"><?php echo $row_categoriasNoticias["categoria"]; ?></option>
                                        ...
                                        <div class="form-group">
                                            <div class="col-xs-12">
                                                <div class="form-material">
                                                    <textarea class="form-control" id="bajada" name="bajada" rows="3" placeholder="Ingresa una bajada"></textarea>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-xs-12 push-10">
                                                <!-- CKEditor Container -->
                                                <textarea id="js-ckeditor" name="contenido"></textarea>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="col-md-12">
                                        ...
                                        <div class="form-group">
                                            <div class="col-md-12">
                                                <div class="input-group">
                                                    <input class="form-control" type="text" id="imagen" name="imagen" placeholder="Selecciona una imagen (847x470 px)" readonly required>
                                        ...
                                        <div class="form-group">
                                            <div class="col-xs-12">
                                                ...
                                                <input type="hidden" name="creador" value="<?php echo $row_datosAdmin["nombre"]." ".$row_datosAdmin["apellido"]; ?>">
                                        		<input type="hidden" name="MM_insert" value="noticiasForm">
                                            </div>
                                        </div>
                                    </form>
                                </div>
