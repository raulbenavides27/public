...
<html lang="es">
    ...
    <head>
        ...
        <title>Panel de Administraci&oacute;n | Ingreso de Usuarios</title>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-sm-8 col-sm-offset-2 text">
                            <h1><strong>Panel de</strong> Administración</h1>
                            <div class="description">
                            	<p>Hubo un error con tus datos. Si tienes alguna duda, olvidaste tus credenciales o quieres demostrarme tu amor escríbeme a <a href="mailto:hola@diegokingkong.com"><strong>hola@diegokingkong.com</strong></a>.</p>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-sm-6 col-sm-offset-3 form-box">
                            ...
                            <div class="form-bottom">
			                    <form role="form" action="<?php echo $loginFormAction; ?>" method="POST" name="ingreso" class="login-form">
			                    	<div class="form-group">
			                    		<label class="sr-only" for="form-username">Correo</label>
			                        	<input type="text" name="correo" placeholder="correo@electronico.com" class="form-username form-control" id="form-username" style="border-color:#DE615E;">
			                        </div>
			                        <div class="form-group">
			                        	<label class="sr-only" for="form-password">Password</label>
			                        	<input type="password" name="password" placeholder="********" class="form-password form-control" id="form-password" style="border-color:#DE615E;">
			                        </div>
