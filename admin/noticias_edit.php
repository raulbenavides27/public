...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "noticiasForm")) {
  $updateSQL = sprintf("UPDATE noticias SET titulo=%s, tituloSEO=%s, categoriaSEO=%s, bajada=%s, contenido=%s, imagen=%s, keywords=%s, estado=%s WHERE id=%s",
  ...
  $updateGoTo = "resize847x470edit.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
$query_noticiaEdit = sprintf("SELECT * FROM noticias WHERE noticias.id = '$idNoticia'");
$noticiaEdit = mysqli_query($DKKadmin, $query_noticiaEdit) or die(mysqli_error($DKKadmin));
$row_noticiaEdit = mysqli_fetch_assoc($noticiaEdit);
$totalRows_noticiaEdit = mysqli_num_rows($noticiaEdit);

$query_categoriasNoticias = sprintf("SELECT * FROM noticiasCategorias ORDER BY noticiasCategorias.id ASC");
$categoriasNoticias = mysqli_query($DKKadmin, $query_categoriasNoticias) or die(mysqli_error($DKKadmin));
$row_categoriasNoticias = mysqli_fetch_assoc($categoriasNoticias);
$totalRows_categoriasNoticias = mysqli_num_rows($categoriasNoticias);

$query_ultimaNoticia = sprintf("SELECT * FROM noticias ORDER BY noticias.id DESC LIMIT 1");
$ultimaNoticia = mysqli_query($DKKadmin, $query_ultimaNoticia) or die(mysqli_error($DKKadmin));
$row_ultimaNoticia = mysqli_fetch_assoc($ultimaNoticia);
$totalRows_ultimaNoticia = mysqli_num_rows($ultimaNoticia);
?>
    ...
    <body>
        ...
        <div id="page-container" class="sidebar-l sidebar-o side-scroll header-navbar-fixed">
            ...
            <main id="main-container">
                ...
                {
                    self.name = 'opener';
                    remote = open('up/noticias.php', 'remote', 'width=410,height=200,location=no,scrollbar=no,menubars=no,toolbars=no,resizable=no,fullscreen=no, status=yes');
                    remote.focus();
                    }	
                </script>
                <!-- fin script -->
                ...
                <div class="content content-boxed">
                        ...
                        <div class="col-xs-6 col-sm-4">
                            <a class="block block-link-hover3 text-center" href="javascript:void(0)">
                                <div class="block-content block-content-full">
                                    <div class="h1 font-w700" data-toggle="countTo" data-to="<?php echo $row_noticiaEdit["id"]; ?>"></div>
                                </div>
                                <div class="block-content block-content-full block-content-mini bg-gray-lighter text-muted font-w600">ID</div>
                            </a>
                        </div>
                        <div class="col-xs-6 col-sm-4">
                            <a class="block block-link-hover3 text-center" href="javascript:void(0)">
                                <div class="block-content block-content-full">
                                    <div class="h1 font-w700" data-toggle="countTo" data-to="<?php echo $row_noticiaEdit["visitas"]; ?>"></div>
                                </div>
                                <div class="block-content block-content-full block-content-mini bg-gray-lighter text-muted font-w600">Visitas</div>
                            </a>
                        </div>
                        <div class="col-xs-12 col-sm-4">
                            <a class="block block-link-hover3 text-center" href="noticias_remove.php?id=<?php echo $row_noticiaEdit["id"]; ?>">
                                <div class="block-content block-content-full">
                    ...
                    <div class="block">
                        <div class="block-header bg-gray-lighter">
                            <h3 class="block-title">Editar Noticia</h3>
                        </div>
                        <div class="block-content block-content-full">
                            <div class="row">
                                <div class="col-sm-8 col-sm-offset-2 col-lg-6 col-lg-offset-3">
                                    <form class="form-horizontal push-30-t push-30" name="noticiasForm" action="<?php echo $editFormAction; ?>" method="post">
                                        <div class="form-group">
                                            <div class="col-xs-12">
                                                <div class="form-material form-material-primary">
                                                    <input class="form-control" type="text" id="id" name="id" value="<?php echo $row_noticiaEdit["id"]; ?>" readonly >
                                        ...
                                        <div class="form-group">
                                            <div class="col-xs-12">
                                                <div class="form-material form-material-primary">
                                                    <input class="form-control" type="text" id="titulo" name="titulo" value="<?php echo $row_noticiaEdit["titulo"]; ?>">
                                        ...
                                        <div class="form-group">
                                            <div class="col-xs-12">
                                                <div class="form-material form-material-primary">
                                                    <input class="form-control" type="text" id="tituloSEO" name="tituloSEO" value="<?php echo $row_noticiaEdit["tituloSEO"]; ?>">
                                                    <label for="tituloSEO">T&iacute;tulo SEO</label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="col-xs-12">
                                                <div class="form-material">
                                                    <select class="js-select2 form-control" id="categoriaSEO" name="categoriaSEO" style="width: 100%;" data-placeholder="Selecciona su categor&iacute;a..">
                                                        <option></option>
                                                        <?php do { ?>
                                                        <option value="<?php echo $row_categoriasNoticias["categoriaSEO"]; ?>" <?php if ($row_noticiaEdit["categoriaSEO"] == $row_categoriasNoticias["categoriaSEO"]) {echo"selected";} ?>><?php echo $row_categoriasNoticias["categoria"]; ?></option>
                                                        <?php } while ($row_categoriasNoticias = mysqli_fetch_assoc($categoriasNoticias)); ?>
                                                    </select>
                                        ...
                                        <div class="form-group">
                                            <div class="col-xs-12">
                                                <div class="form-material">
                                                    <textarea class="form-control" id="bajada" name="bajada" rows="3" placeholder="Ingresa una bajada"><?php echo $row_noticiaEdit["bajada"]; ?></textarea>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-xs-12 push-10">
                                                <!-- CKEditor Container -->
                                                <textarea id="js-ckeditor" name="contenido"><?php echo $row_noticiaEdit["contenido"]; ?></textarea>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="col-md-12">
                                                <div class="input-group">
                                                    <label for="imagen">Imagen de la Noticia (847x470 px)</label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="col-md-12">
                                                <div class="input-group">
                                                    <input class="form-control" type="text" id="imagen" name="imagen" placeholder="Selecciona una imagen (847x470 px)" readonly required value="<?php echo $row_noticiaEdit["imagen"]; ?>">
                                        ...
                                        <div class="form-group">
                                            <div class="col-xs-12">
                                                <div class="form-material form-material-primary">
                                                    <input class="js-tags-input form-control" type="text" id="keywords" name="keywords" value="<?php echo $row_noticiaEdit["keywords"]; ?>">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-xs-12">
                                                <label class="css-input switch switch-sm switch-primary">
                                                    <input type="checkbox" id="estado" name="estado" <?php if ($row_noticiaEdit["estado"] == '1') {echo"checked";} ?>><span></span>
                                                </label>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="col-xs-12">
                                                ...
                                                <input type="hidden" name="id" value="<?php echo $row_noticiaEdit["id"]; ?>">
                                                <input type="hidden" name="MM_update" value="noticiasForm">
                                            </div>
                                        </div>
                                    </form>
                                </div>
...
mysqli_free_result($noticiaEdit);

mysqli_free_result($categoriasNoticias);

mysqli_free_result($ultimaNoticia);
?>
