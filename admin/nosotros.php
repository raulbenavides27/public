...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "nosotrosForm")) {
  $insertSQL = sprintf("INSERT INTO nosotros (titulo, laEmpresa, imagen1, imagen2, imagen3, fechaID, estado) VALUES (%s, %s, %s, %s, %s, %s, %s)",
                       GetSQLValueString($_POST['titulo'], "text"),
                       GetSQLValueString($_POST['laEmpresa'], "text"),
    ...
    <body>
        ...
        <div id="page-container" class="sidebar-l sidebar-o side-scroll header-navbar-fixed">
            ...
            <main id="main-container">
                ...
                {
                    self.name = 'opener';
                    remote = open('up/nosotros1.php', 'remote', 'width=410,height=200,location=no,scrollbar=no,menubars=no,toolbars=no,resizable=no,fullscreen=no, status=yes');
                    remote.focus();
                    }	
                function upload2()
                {
                    self.name = 'opener';
                    remote = open('up/nosotros2.php', 'remote', 'width=410,height=200,location=no,scrollbar=no,menubars=no,toolbars=no,resizable=no,fullscreen=no, status=yes');
                    remote.focus();
                    }	
                function upload3()
                {
                    self.name = 'opener';
                    remote = open('up/nosotros3.php', 'remote', 'width=410,height=200,location=no,scrollbar=no,menubars=no,toolbars=no,resizable=no,fullscreen=no, status=yes');
                    remote.focus();
                    }	
                </script>
                <!-- fin script -->
                                ...
                                <div class="col-sm-8 col-sm-offset-2 col-lg-6 col-lg-offset-3">
                                    <form action="<?php echo $editFormAction; ?>" class="form-horizontal push-30-t push-30" method="post" name="nosotrosForm">
                                        <div class="form-group">
                                            ...
                                            <div class="col-xs-12 push-10">
                                                <!-- CKEditor Container -->
                                                <textarea name="titulo" rows="2" style="width:100%;"><?php echo $row_contenidoNosotros["titulo"]; ?></textarea>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="col-xs-12 push-10">
                                            ...
                                            <div class="col-xs-12 push-10">
                                                <!-- CKEditor Container -->
                                                <textarea id="js-ckeditor" name="contenido"><?php echo $row_contenidoNosotros["laEmpresa"]; ?></textarea>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="col-md-12">
                                        ...
                                        <div class="form-group">
                                            <div class="col-md-12">
                                                <div class="input-group">
                                                    <input class="form-control" type="text" id="imagen" name="imagen" placeholder="Selecciona una imagen (525x380 px)" readonly required value="<?php echo $row_contenidoNosotros["imagen1"]; ?>">
                                        ...
                                        <div class="form-group">
                                            <div class="col-md-12">
                                                <div class="input-group">
                                                    <input class="form-control" type="text" id="imagen" name="imagen" placeholder="Selecciona una imagen (525x380 px)" readonly required value="<?php echo $row_contenidoNosotros["imagen2"]; ?>">
                                                    <span class="input-group-btn">
                                        ...
                                        <div class="form-group">
                                            <div class="col-md-12">
                                                <div class="input-group">
                                                    <input class="form-control" type="text" id="imagen" name="imagen" placeholder="Selecciona una imagen (525x380 px)" readonly required value="<?php echo $row_contenidoNosotros["imagen3"]; ?>">
                                                    <span class="input-group-btn">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-xs-12">
                                                <label class="css-input switch switch-sm switch-primary">
                                                    <input type="checkbox" id="estado" name="estado" <?php if ($row_contenidoNosotros["estado"] == '1') {echo "checked";} ?>><span></span>
                                                </label>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="col-xs-12">
                                                ...
                                                <input type="hidden" name="mision" value="<?php echo $row_contenidoNosotros["mision"]; ?>">
