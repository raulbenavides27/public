...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "subCategoriasForm")) {
  $updateSQL = sprintf("UPDATE menuSubCategorias SET idCategoria=%s, subCategoria=%s, subCategoriaSEO=%s, titulo=%s, bajada=%s, imagen=%s, keywords=%s, estado=%s WHERE id=%s",
...
$query_subCategoriasProductosEdit = sprintf("SELECT * FROM menuSubCategorias WHERE menuSubCategorias.id = '$idSubCategoria'");
$subCategoriasProductosEdit = mysqli_query($DKKadmin, $query_subCategoriasProductosEdit) or die(mysqli_error($DKKadmin));
$row_subCategoriasProductosEdit = mysqli_fetch_assoc($subCategoriasProductosEdit);
$totalRows_subCategoriasProductosEdit = mysqli_num_rows($subCategoriasProductosEdit);
?>
<!DOCTYPE html>
                                ...
                                <div class="block-content">
                                  <form action="<?php echo $editFormAction; ?>" class="form-horizontal push-10-t push-10" method="POST" name="subCategoriasForm">
                                        <div class="form-group">
                                            ...
                                            <div class="col-xs-12">
                                                <div class="form-control-static">#SBCT0<?php echo $row_subCategoriasProductosEdit["id"]; ?></div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="col-xs-12">
                                                <div class="form-material">
                                                    <select class="js-select2 form-control" id="idCategoria" name="idCategoria" style="width: 100%;" data-placeholder="Selecciona su categor&iacute;a..">
                                                        <option></option>
                                                        <?php do { ?>
                                                        <option value="<?php echo $row_categoriasProductos["id"]; ?>" <?php if ($row_subCategoriasProductosEdit["idCategoria"] == $row_categoriasProductos["id"]) {echo"selected";} ?>><?php echo $row_categoriasProductos["categoria"]; ?></option>
                                        ...
                                        <div class="form-group">
                                            <div class="col-xs-12">
                                                <div class="form-material">
                                                    <input class="form-control" type="text" id="subCategoria" name="subCategoria" placeholder="Ingresa el Nombre" value="<?php echo $row_subCategoriasProductosEdit["subCategoria"]; ?>">
                                        ...
                                        <div class="form-group">
                                            <div class="col-xs-12">
                                                <div class="form-material">
                                                    <input class="form-control" type="text" id="subCategoriaSEO" name="subCategoriaSEO" placeholder="Ingresa el Nombre SEO" value="<?php echo $row_subCategoriasProductosEdit["subCategoriaSEO"]; ?>">
                                        ...
                                        <div class="form-group">
                                            <div class="col-xs-12">
                                                <div class="form-material">
                                                    <input class="form-control" type="text" id="titulo" name="titulo" placeholder="Ingresa el T&iacute;tulo de la Categor&iacute;a" value="<?php echo $row_subCategoriasProductosEdit["titulo"]; ?>">
                                        ...
                                        <div class="form-group">
                                            <div class="col-xs-12">
                                                <div class="form-material">
                                                    <textarea class="form-control" id="bajada" name="bajada" rows="3" placeholder="Ingresa una descripci&oacute;n para la categor&iacute;a"><?php echo $row_subCategoriasProductosEdit["bajada"]; ?></textarea>
                                        ...
                                        <div class="form-group">
                                            <div class="col-md-12">
                                                <div class="input-group">
                                                    <input class="form-control" type="text" id="imagen" name="imagen" placeholder="Selecciona una imagen (850x320 px)" readonly required value="<?php echo $row_subCategoriasProductosEdit["imagen"]; ?>">
                                        ...
                                        <div class="form-group">
                                            <div class="col-xs-12">
                                                <div class="form-material form-material-primary">
                                                    <input class="js-tags-input form-control" type="text" id="keywords" name="keywords" value="<?php echo $row_subCategoriasProductosEdit["keywords"]; ?>">
                                        ...
                                        <div class="form-group">
                                            <div class="col-xs-12">
                                                <label class="css-input switch switch-sm switch-success">
                                                    <input type="checkbox" id="estado" name="estado" <?php if ($row_subCategoriasProductosEdit["estado"] == '1') {echo "checked";} ?>><span></span> Estado
                                                </label>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="col-xs-12">
                                                ...
                                                <input type="hidden" name="id" value="<?php echo $row_subCategoriasProductosEdit["id"]; ?>">
                                            </div>
                                        </div>
                                        <input type="hidden" name="MM_update" value="subCategoriasForm">
                                    </form>
                                </div>
                            </div>
                            <!-- END formulario -->
...
mysqli_free_result($subCategoriasProductosEdit);
?>
