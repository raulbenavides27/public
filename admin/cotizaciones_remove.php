...
<?php
//Actualizar Estado
  $updateSQL = sprintf("UPDATE cotizaciones SET cotizaciones.estado = '0' WHERE cotizaciones.id = %s",GetSQLValueString($varID_ConsultaChange, "int"));
  $Result1 = mysqli_query($DKKadmin, $updateSQL) or die(mysqli_error($DKKadmin));
  $updateGoTo = "cotizaciones.php";
