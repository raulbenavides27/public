...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "blogForm")) {
  $updateSQL = sprintf("UPDATE blog SET titulo=%s, tituloSEO=%s, categoriaSEO=%s, bajada=%s, contenido=%s, imagen=%s, keywords=%s, estado=%s WHERE id=%s",
...
$query_blogEdit = sprintf("SELECT * FROM blog WHERE blog.id = '$idNoticia'");
$blogEdit = mysqli_query($DKKadmin, $query_blogEdit) or die(mysqli_error($DKKadmin));
$row_blogEdit = mysqli_fetch_assoc($blogEdit);
$totalRows_blogEdit = mysqli_num_rows($blogEdit);

$query_categoriasBlog = sprintf("SELECT * FROM blogCategorias ORDER BY blogCategorias.id ASC");
$categoriasBlog = mysqli_query($DKKadmin, $query_categoriasBlog) or die(mysqli_error($DKKadmin));
$row_categoriasBlog = mysqli_fetch_assoc($categoriasBlog);
$totalRows_categoriasBlog = mysqli_num_rows($categoriasBlog);

$query_ultimoPost = sprintf("SELECT * FROM blog ORDER BY blog.id DESC LIMIT 1");
$ultimoPost = mysqli_query($DKKadmin, $query_ultimoPost) or die(mysqli_error($DKKadmin));
$row_ultimoPost = mysqli_fetch_assoc($ultimoPost);
$totalRows_ultimoPost = mysqli_num_rows($ultimoPost);
?>
    ...
    <body>
        ...
        <div id="page-container" class="sidebar-l sidebar-o side-scroll header-navbar-fixed">
            ...
            <main id="main-container">
                ...
                {
                    self.name = 'opener';
                    remote = open('up/blog.php', 'remote', 'width=410,height=200,location=no,scrollbar=no,menubars=no,toolbars=no,resizable=no,fullscreen=no, status=yes');
                    remote.focus();
                    }	
                </script>
                <!-- fin script -->
                ...
                <div class="content content-boxed">
                    ...
                    <div class="row">
                        <div class="col-xs-6 col-sm-4">
                            <a class="block block-link-hover3 text-center" href="javascript:void(0)">
                                <div class="block-content block-content-full">
                                    <div class="h1 font-w700" data-toggle="countTo" data-to="<?php echo $row_blogEdit["id"]; ?>"></div>
                                </div>
                        ...
                        <div class="col-xs-6 col-sm-4">
                            <a class="block block-link-hover3 text-center" href="javascript:void(0)">
                                <div class="block-content block-content-full">
                                    <div class="h1 font-w700" data-toggle="countTo" data-to="<?php echo $row_blogEdit["visitas"]; ?>"></div>
                                </div>
                                <div class="block-content block-content-full block-content-mini bg-gray-lighter text-muted font-w600">Visitas</div>
                            </a>
                        </div>
                        <div class="col-xs-12 col-sm-4">
                            <a class="block block-link-hover3 text-center" href="blog_remove.php?id=<?php echo $row_blogEdit["id"]; ?>">
                                <div class="block-content block-content-full">
                        ...
                        <div class="block-content block-content-full">
                            <div class="row">
                                <div class="col-sm-8 col-sm-offset-2 col-lg-6 col-lg-offset-3">
                                    <form class="form-horizontal push-30-t push-30" name="blogForm" action="<?php echo $editFormAction; ?>" method="post">
                                        <div class="form-group">
                                            <div class="col-xs-12">
                                                <div class="form-material form-material-primary">
                                                    <input class="form-control" type="text" id="id" name="id" value="<?php echo $row_blogEdit["id"]; ?>" readonly >
                                        ...
                                        <div class="form-group">
                                            <div class="col-xs-12">
                                                <div class="form-material form-material-primary">
                                                    <input class="form-control" type="text" id="titulo" name="titulo" value="<?php echo $row_blogEdit["titulo"]; ?>">
                                        ...
                                        <div class="form-group">
                                            <div class="col-xs-12">
                                                <div class="form-material form-material-primary">
                                                    <input class="form-control" type="text" id="tituloSEO" name="tituloSEO" value="<?php echo $row_blogEdit["tituloSEO"]; ?>">
                                            ...
                                            <div class="col-xs-12">
                                                <div class="form-material">
                                                    <select class="js-select2 form-control" id="categoriaSEO" name="categoriaSEO" style="width: 100%;" data-placeholder="Selecciona su categor&iacute;a..">
                                                        <option></option>
                                                        <?php do { ?>
                                                        <option value="<?php echo $row_categoriasBlog["categoriaSEO"]; ?>" <?php if ($row_blogEdit["categoriaSEO"] == $row_categoriasBlog["categoriaSEO"]) {echo"selected";} ?>><?php echo $row_categoriasBlog["categoria"]; ?></option>
                                                        <?php } while ($row_categoriasBlog = mysqli_fetch_assoc($categoriasBlog)); ?>
                                                    </select>
                                        ...
                                        <div class="form-group">
                                            <div class="col-xs-12">
                                                <div class="form-material">
                                                    <textarea class="form-control" id="bajada" name="bajada" rows="3" placeholder="Ingresa una bajada"><?php echo $row_blogEdit["bajada"]; ?></textarea>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-xs-12 push-10">
                                                <!-- CKEditor Container -->
                                                <textarea id="js-ckeditor" name="contenido"><?php echo $row_blogEdit["contenido"]; ?></textarea>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="col-md-12">
                                                <div class="input-group">
                                                    <label for="imagen">Imagen de la Noticia (865x450 px)</label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="col-md-12">
                                                <div class="input-group">
                                                    <input class="form-control" type="text" id="imagen" name="imagen" placeholder="Selecciona una imagen (865x450 px)" readonly required value="<?php echo $row_blogEdit["imagen"]; ?>">
                                        ...
                                        <div class="form-group">
                                            <div class="col-xs-12">
                                                <div class="form-material form-material-primary">
                                                    <input class="js-tags-input form-control" type="text" id="keywords" name="keywords" value="<?php echo $row_blogEdit["keywords"]; ?>">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-xs-12">
                                                <label class="css-input switch switch-sm switch-primary">
                                                    <input type="checkbox" id="estado" name="estado" <?php if ($row_blogEdit["estado"] == '1') {echo"checked";} ?>><span></span>
                                                </label>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="col-xs-12">
                                                ...
                                                <input type="hidden" name="id" value="<?php echo $row_blogEdit["id"]; ?>">
                                                <input type="hidden" name="MM_update" value="blogForm">
                                            </div>
                                        </div>
                                    </form>
                                </div>
...
mysqli_free_result($blogEdit);

mysqli_free_result($categoriasBlog);

mysqli_free_result($ultimoPost);
?>
