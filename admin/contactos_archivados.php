...
;
$query_contactosShow = "SELECT * FROM contacto WHERE contacto.estado = '3' ORDER BY contacto.id DESC";
...
;
$query_contactosShowTodos = "SELECT * FROM contacto WHERE contacto.estado = '3' ORDER BY contacto.id DESC";
