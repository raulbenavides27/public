...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "categoriasForm")) {
  $updateSQL = sprintf("INSERT INTO menuCategorias (categoria, categoriaSEO, titulo, bajada, imagen, keywords, estado) VALUES (%s, %s, %s, %s, %s, %s, %s)",
                    ...
                    <div class="row items-push">
                        <div class="col-sm-7">
                            <h1 class="page-heading">
                                Categor&iacute;as <small>Estas son las categor&iacute;as presentes en al cat&aacute;logo</small>
                            </h1>
                        </div>
                                ...
                                <div class="block-content">
                                  <form action="<?php echo $editFormAction; ?>" class="form-horizontal push-10-t push-10" method="POST" name="categoriasForm">
                                        <div class="form-group">
                                            ...
                                            <div class="col-xs-12">
                                                <div class="form-control-static">#CT0<?php echo ($row_categoriasProductos["id"] +1); ?></div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="col-xs-12">
                                                <div class="form-material">
                                                    <input class="form-control" type="text" id="categoria" name="categoria" placeholder="Ingresa el Nombre">
                                        ...
                                        <div class="form-group">
                                            <div class="col-xs-12">
                                                <div class="form-material">
                                                    <input class="form-control" type="text" id="categoriaSEO" name="categoriaSEO" placeholder="Ingresa el Nombre SEO">
