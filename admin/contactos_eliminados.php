...
;
$query_contactosShow = "SELECT * FROM contacto WHERE contacto.estado = '0' ORDER BY contacto.id DESC";
...
;
$query_contactosShowTodos = "SELECT * FROM contacto WHERE contacto.estado = '0' ORDER BY contacto.id DESC";
                                        ...
                                        <table class="js-table-checkable table table-hover table-vcenter">
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="visible-lg text-muted" style="width: 70px;">
                                                      <?php if ($row_contactosShow["estado"] == '0') { ?><a href='contactos_delete.php?id=<?php echo $row_contactosShow["id"]; ?>'><i class='fa fa-times text-danger'></i></a><?php } ?>
                                                    </td>
