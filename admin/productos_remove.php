...
;
$query_ConsultaChange = sprintf("SELECT * FROM productos WHERE productos.id = %s", GetSQLValueString($varID_ConsultaChange, "int"));
...
<?php
//Actualizar Estado
  $updateSQL = sprintf("UPDATE productos SET productos.estado = '0' WHERE productos.id = %s",GetSQLValueString($varID_ConsultaChange, "int"));
