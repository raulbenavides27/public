...
$query_whatsappHoy = "SELECT * FROM visitas WHERE visitas.pagina = 'whatsapp' AND visitas.fechaID >= '$fechaAyer' AND visitas.fechaID <= '$fechaID' ORDER BY visitas.id DESC";
$whatsappHoy = mysqli_query($DKKadmin, $query_whatsappHoy) or die(mysqli_error($DKKadmin));
$row_whatsappHoy = mysqli_fetch_assoc($whatsappHoy);
$totalRows_whatsappHoy = mysqli_num_rows($whatsappHoy);

$query_whatsappAyer = "SELECT * FROM visitas WHERE visitas.pagina = 'whatsapp' AND visitas.fechaID >= '$fecha2dias' AND visitas.fechaID <= '$fechaAyer' ORDER BY visitas.id DESC";
$whatsappAyer = mysqli_query($DKKadmin, $query_whatsappAyer) or die(mysqli_error($DKKadmin));
$row_whatsappAyer = mysqli_fetch_assoc($whatsappAyer);
$totalRows_whatsappAyer = mysqli_num_rows($whatsappAyer);

$query_whatsapp2dias = "SELECT * FROM visitas WHERE visitas.pagina = 'whatsapp' AND visitas.fechaID >= '$fecha3dias' AND visitas.fechaID <= '$fecha2dias' ORDER BY visitas.id DESC";
$whatsapp2dias = mysqli_query($DKKadmin, $query_whatsapp2dias) or die(mysqli_error($DKKadmin));
$row_whatsapp2dias = mysqli_fetch_assoc($whatsapp2dias);
$totalRows_whatsapp2dias = mysqli_num_rows($whatsapp2dias);

$query_whatsapp3dias = "SELECT * FROM visitas WHERE visitas.pagina = 'whatsapp' AND visitas.fechaID >= '$fecha4dias' AND visitas.fechaID <= '$fecha3dias' ORDER BY visitas.id DESC";
$whatsapp3dias = mysqli_query($DKKadmin, $query_whatsapp3dias) or die(mysqli_error($DKKadmin));
$row_whatsapp3dias = mysqli_fetch_assoc($whatsapp3dias);
$totalRows_whatsapp3dias = mysqli_num_rows($whatsapp3dias);

$query_whatsapp4dias = "SELECT * FROM visitas WHERE visitas.pagina = 'whatsapp' AND visitas.fechaID >= '$fecha5dias' AND visitas.fechaID <= '$fecha4dias' ORDER BY visitas.id DESC";
$whatsapp4dias = mysqli_query($DKKadmin, $query_whatsapp4dias) or die(mysqli_error($DKKadmin));
$row_whatsapp4dias = mysqli_fetch_assoc($whatsapp4dias);
$totalRows_whatsapp4dias = mysqli_num_rows($whatsapp4dias);

$query_whatsapp5dias = "SELECT * FROM visitas WHERE visitas.pagina = 'whatsapp' AND visitas.fechaID >= '$fecha6dias' AND visitas.fechaID <= '$fecha5dias' ORDER BY visitas.id DESC";
$whatsapp5dias = mysqli_query($DKKadmin, $query_whatsapp5dias) or die(mysqli_error($DKKadmin));
$row_whatsapp5dias = mysqli_fetch_assoc($whatsapp5dias);
$totalRows_whatsapp5dias = mysqli_num_rows($whatsapp5dias);

$query_whatsapp6dias = "SELECT * FROM visitas WHERE visitas.pagina = 'whatsapp' AND visitas.fechaID >= '$fecha7dias' AND visitas.fechaID <= '$fecha6dias' ORDER BY visitas.id DESC";
$whatsapp6dias = mysqli_query($DKKadmin, $query_whatsapp6dias) or die(mysqli_error($DKKadmin));
$row_whatsapp6dias = mysqli_fetch_assoc($whatsapp6dias);
$totalRows_whatsapp6dias = mysqli_num_rows($whatsapp6dias);

$query_whatsapp7dias = "SELECT * FROM visitas WHERE visitas.pagina = 'whatsapp' AND visitas.fechaID >= '$fecha8dias' AND visitas.fechaID <= '$fecha7dias' ORDER BY visitas.id DESC";
$whatsapp7dias = mysqli_query($DKKadmin, $query_whatsapp7dias) or die(mysqli_error($DKKadmin));
$row_whatsapp7dias = mysqli_fetch_assoc($whatsapp7dias);
$totalRows_whatsapp7dias = mysqli_num_rows($whatsapp7dias);

$query_whatsapp8dias = "SELECT * FROM visitas WHERE visitas.pagina = 'whatsapp' AND visitas.fechaID >= '$fecha9dias' AND visitas.fechaID <= '$fecha8dias' ORDER BY visitas.id DESC";
$whatsapp8dias = mysqli_query($DKKadmin, $query_whatsapp8dias) or die(mysqli_error($DKKadmin));
$row_whatsapp8dias = mysqli_fetch_assoc($whatsapp8dias);
$totalRows_whatsapp8dias = mysqli_num_rows($whatsapp8dias);

$query_whatsapp9dias = "SELECT * FROM visitas WHERE visitas.pagina = 'whatsapp' AND visitas.fechaID >= '$fecha10dias' AND visitas.fechaID <= '$fecha9dias' ORDER BY visitas.id DESC";
$whatsapp9dias = mysqli_query($DKKadmin, $query_whatsapp9dias) or die(mysqli_error($DKKadmin));
$row_whatsapp9dias = mysqli_fetch_assoc($whatsapp9dias);
$totalRows_whatsapp9dias = mysqli_num_rows($whatsapp9dias);
...
$whatsapp11dias = mysqli_query($DKKadmin, $query_whatsapp11dias) or die(mysqli_error($DKKadmin));
$row_whatsapp11dias = mysqli_fetch_assoc($whatsapp11dias);
$totalRows_whatsapp11dias = mysqli_num_rows($whatsapp11dias);

$query_whatsapp12dias = "SELECT * FROM visitas WHERE visitas.pagina = 'whatsapp' AND visitas.fechaID >= '$fecha13dias' AND visitas.fechaID <= '$fecha12dias' ORDER BY visitas.id DESC";
$whatsapp12dias = mysqli_query($DKKadmin, $query_whatsapp12dias) or die(mysqli_error($DKKadmin));
$row_whatsapp12dias = mysqli_fetch_assoc($whatsapp12dias);
$totalRows_whatsapp12dias = mysqli_num_rows($whatsapp12dias);

$query_whatsapp13dias = "SELECT * FROM visitas WHERE visitas.pagina = 'whatsapp' AND visitas.fechaID >= '$fecha14dias' AND visitas.fechaID <= '$fecha13dias' ORDER BY visitas.id DESC";
$whatsapp13dias = mysqli_query($DKKadmin, $query_whatsapp13dias) or die(mysqli_error($DKKadmin));
$row_whatsapp13dias = mysqli_fetch_assoc($whatsapp13dias);
$totalRows_whatsapp13dias = mysqli_num_rows($whatsapp13dias);
					...
					<div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="block block-rounded block-opt-refresh-icon8">
                                ...
                                <div class="block-content block-content-full bg-gray-lighter text-center">
                                    <div style="height: 340px;"><canvas class="js-dash-chartjs-whatsapp"></canvas></div>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <script src="js/core/jquery.min.js"></script>
        ...
        var BasePagesDashboardv2 = function() {
			...
			var initDashv2ChartJS = function(){
				...
				var $dashChartWhatsappCon    = jQuery('.js-dash-chartjs-whatsapp')[0].getContext('2d');
				...
				// Whastapp Data
				var $dashChartWhatsappData = {
					labels: ['1 SEMANA', '6 DIAS', '5 DIAS', '4 DIAS', '3 DIAS', 'AYER', 'HOY'],
					datasets: [
						{
							label: 'Esta Semana',
							fillColor: 'rgba(37, 211, 102, .07)',
							strokeColor: 'rgba(37, 211, 102, .25)',
							pointColor: 'rgba(37, 211, 102, .25)',
							pointStrokeColor: '#fff',
							pointHighlightFill: '#fff',
							pointHighlightStroke: 'rgba(37, 211, 102, 1)',
							data: [<?php echo $totalRows_whatsapp6dias; ?>, <?php echo $totalRows_whatsapp5dias; ?>, <?php echo $totalRows_whatsapp4dias; ?>, <?php echo $totalRows_whatsapp3dias; ?>, <?php echo $totalRows_whatsapp2dias; ?>, <?php echo $totalRows_whatsappAyer; ?>, <?php echo $totalRows_whatsappHoy; ?>]
						},
						{
							label: 'Semana Pasada',
							fillColor: 'rgba(37, 211, 102, .25)',
							strokeColor: 'rgba(37, 211, 102, .55)',
							pointColor: 'rgba(37, 211, 102, .55)',
							pointStrokeColor: '#fff',
							pointHighlightFill: '#fff',
							pointHighlightStroke: 'rgba(37, 211, 102, 1)',
							data: [<?php echo $totalRows_whatsapp13dias; ?>, <?php echo $totalRows_whatsapp12dias; ?>, <?php echo $totalRows_whatsapp11dias; ?>, <?php echo $totalRows_whatsapp10dias; ?>, <?php echo $totalRows_whatsapp9dias; ?>, <?php echo $totalRows_whatsapp8dias; ?>, <?php echo $totalRows_whatsapp7dias; ?>]
						}
					]
				};
				...
				// Init WhatsApp Chart
				var $dashChartWhatsapp = new Chart($dashChartWhatsappCon).Line($dashChartWhatsappData, {
					scaleFontFamily: "'Open Sans', 'Helvetica Neue', Helvetica, Arial, sans-serif",
					scaleFontColor: '#999',
					scaleFontStyle: '600',
					tooltipTitleFontFamily: "'Open Sans', 'Helvetica Neue', Helvetica, Arial, sans-serif",
...
mysqli_free_result($whatsappHoy);

mysqli_free_result($whatsappAyer);

mysqli_free_result($whatsapp2dias);

mysqli_free_result($whatsapp3dias);

mysqli_free_result($whatsapp4dias);

mysqli_free_result($whatsapp5dias);

mysqli_free_result($whatsapp6dias);

mysqli_free_result($whatsapp7dias);

mysqli_free_result($whatsapp8dias);

mysqli_free_result($whatsapp9dias);

mysqli_free_result($whatsapp10dias);

mysqli_free_result($whatsapp11dias);

mysqli_free_result($whatsapp12dias);

mysqli_free_result($whatsapp13dias);
