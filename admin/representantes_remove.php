...
$query_ConsultaChange = sprintf("SELECT * FROM representantes WHERE representantes.id = %s", GetSQLValueString($varID_ConsultaChange, "int"));
...
<?php
//Actualizar Estado
  $updateSQL = sprintf("UPDATE representantes SET representantes.estado = '0' WHERE representantes.id = %s",GetSQLValueString($varID_ConsultaChange, "int"));
