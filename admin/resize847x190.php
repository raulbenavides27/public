...
$query_resizeID = "SELECT * FROM nosotros ORDER BY nosotros.id DESC LIMIT 1";
...
$totalRows_resizeID = mysqli_num_rows($resizeID);
	...
	$resizeObj = new resize("../images/uploads/".$imagen);

	// *** 2) Resize image (options: exact, portrait, landscape, auto, crop)
	$resizeObj -> resizeImage(847, 190, 'crop');

	// *** 3) Save image
	$resizeObj -> saveImage("../images/uploads/".$imagen, 100);


mysqli_free_result($resizeID);
?>
<META HTTP-EQUIV='Refresh' CONTENT='0; URL=nosotros.php'>