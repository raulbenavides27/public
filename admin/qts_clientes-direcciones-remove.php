...
$query_ConsultaChange = sprintf("SELECT * FROM qts_clientesDirecciones WHERE qts_clientesDirecciones.id = %s", GetSQLValueString($varID_ConsultaChange, "int"));
...
//Actualizar Estado
  $updateSQL = sprintf("UPDATE qts_clientesDirecciones SET qts_clientesDirecciones.estado = '0' WHERE qts_clientesDirecciones.id = %s",GetSQLValueString($varID_ConsultaChange, "int"));
