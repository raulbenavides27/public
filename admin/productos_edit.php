...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "productosForm")) {
  $updateSQL = sprintf("UPDATE productos SET codInterno=%s, categoriaSEO=%s, subCategoriaSEO=%s, subCategoriaFamiliaSEO=%s, nombre=%s, nombreSEO=%s, descripcionCorta=%s, descripcion=%s, etiqueta=%s, uso=%s, capMax=%s, precio=%s, precioDistribuidor=%s, precioOferta=%s, stock=%s, keywords=%s, imagen1=%s, imagen2=%s, imagen3=%s, novedad=%s, recomendado=%s, estado=%s WHERE id=%s",
                       ...
                       GetSQLValueString($_POST['precioDistribuidor'], "text"),
...
$query_productoEdit = sprintf("SELECT * FROM productos WHERE productos.id = '$idProducto'");
                            ...
                            <div class="row">
                                <div class="col-sm-8 col-sm-offset-2 col-lg-6 col-lg-offset-3">
                                    <form class="form-horizontal push-30-t push-30" name="productosForm" action="<?php echo $editFormAction; ?>" method="post">
                                        <div class="form-group">
                                            <div class="col-xs-12">
                                                <div class="form-material form-material-primary">
                                                    <input class="form-control" type="text" id="id" name="id" value="<?php echo $row_productoEdit["id"]; ?>" readonly >
                                            ...
                                            <div class="col-xs-12">
                                                <div class="form-material">
                                                    <select class="js-select2 form-control" id="categoriaSEO" name="categoriaSEO" style="width: 100%;" data-placeholder="Selecciona su categor&iacute;a..">
                                                        <option></option>
                                                        <?php do { ?>
                                                        <option value="<?php echo $row_categoriasProductos["categoriaSEO"]; ?>" <?php if ($row_productoEdit["categoriaSEO"] == $row_categoriasProductos["categoriaSEO"]) {echo "selected";}?>><?php echo $row_categoriasProductos["categoria"]; ?></option>
                                        ...
                                        <div class="escalasCategoria" <?php if ($row_productoEdit["categoriaSEO"] != 'escalas') {echo"style='display:none;'";} ?>>
                                            <div class="form-group">
                                                <div class="col-xs-12">
                                                    <div class="form-material">
                                                        <select class="js-select2 form-control" id="subCategoriaSEO" name="subCategoriaSEO" style="width: 100%;" data-placeholder="Selecciona su subcategor&iacute;a..">
                                                            <option></option>
                                                            <?php do { ?>
                                                            <option value="<?php echo $row_subCategoriasProductos["subCategoriaSEO"]; ?>" <?php if ($row_productoEdit["subCategoriaSEO"] == $row_subCategoriasProductos["subCategoriaSEO"]) {echo "selected";}?>><?php echo $row_subCategoriasProductos["subCategoria"]; ?></option>
                                                          ...
                                                          <optgroup label="<?php echo $ln['subCategoria'];?>">
                                                              <?php $seleccionaFamilias = mysqli_query($DKKadmin,"SELECT * FROM menuSubCategoriasFamilias WHERE menuSubCategoriasFamilias.estado = '1' AND menuSubCategoriasFamilias.subCategoriaSEO = '$subCategoriaSEO'  ORDER BY menuSubCategoriasFamilias.id ASC"); if(mysqli_num_rows($seleccionaFamilias) == 0) { echo "</optgroup>"; } else { ?>
                                                                <?php $counter = 1; while($lSub = mysqli_fetch_array($seleccionaFamilias)) { ?>
                                                                  <option value="<?php echo $lSub['subCategoriaFamiliaSEO'] ?>" <?php if ($row_productoEdit["subCategoriaFamiliaSEO"] == $lSub['subCategoriaFamiliaSEO']) {echo "selected";}?>><?php echo $lSub['subCategoriaFamilia'] ?></option>
                                                                <?php } ?>
                                                            <?php } ?>
                                                          </optgroup>
                                                        <?php } ?>
                                                ...
                                                <div class="col-xs-4">
                                                    <div class="form-material">
                                                        <select class="js-select2 form-control" id="etiqueta" name="etiqueta" style="width: 100%;" data-placeholder="Selecciona su etiqueta..">
                                                            <option></option>
                                                            <?php do { ?>
                                                            <option value="<?php echo $row_etiquetas["etiquetaSEO"]; ?>" <?php if ($row_productoEdit["etiqueta"] == $row_etiquetas['etiquetaSEO']) {echo "selected";}?>><?php echo $row_etiquetas["etiqueta"]; ?></option>
                                                ...
                                                <div class="col-xs-4">
                                                    <div class="form-material">
                                                        <select class="js-select2 form-control" id="uso" name="uso" style="width: 100%;" data-placeholder="Selecciona su uso..">
                                                            <option></option>
                                                            <?php do { ?>
                                                            <option value="<?php echo $row_usos["usoSEO"]; ?>" <?php if ($row_productoEdit["uso"] == $row_usos['usoSEO']) {echo "selected";}?>><?php echo $row_usos["uso"]; ?></option>
                                                ...
                                                <div class="col-xs-4">
                                                    <div class="form-material">
                                                        <select class="js-select2 form-control" id="capMax" name="capMax" style="width: 100%;" data-placeholder="Selecciona su capacidad..">
                                                            <option></option>
                                                            <?php do { ?>
                                                            <option value="<?php echo $row_capacidades["capMaxSEO"]; ?>" <?php if ($row_productoEdit["capMax"] == $row_capacidades['capMaxSEO']) {echo "selected";}?>><?php echo $row_capacidades["capMax"]; ?></option>
                                        ...
                                        <div class="form-group">
                                            <div class="col-xs-12">
                                                <div class="form-material form-material-primary">
                                                    <input class="form-control" type="text" id="nombre" name="nombre" value="<?php echo $row_productoEdit["nombre"]; ?>">
                                        ...
                                        <div class="form-group">
                                            <div class="col-xs-12">
                                                <div class="form-material form-material-primary">
                                                    <input class="form-control" type="text" id="nombreSEO" name="nombreSEO" value="<?php echo $row_productoEdit["nombreSEO"]; ?>">
                                        ...
                                        <div class="form-group">
                                            <div class="col-xs-12">
                                                <div class="form-material">
                                                    <textarea class="form-control" id="descripcionCorta" name="descripcionCorta" rows="3" placeholder="Ingresa una breve descripci&oacute;n del producto"><?php echo $row_productoEdit["descripcionCorta"]; ?></textarea>
										...
										<div class="form-group">
                                            ...
                                            <div class="col-xs-12 push-10">
                                                <!-- CKEditor Container -->
                                                <textarea id="js-ckeditor" name="descripcion"><?php echo $row_productoEdit["descripcion"]; ?></textarea>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="col-xs-4">
                                                <div class="form-material form-material-primary">
                                                    <input class="form-control" type="number" id="precio" name="precio" value="<?php echo $row_productoEdit["precio"]; ?>">
                                                    <label for="precio">Precio</label>
                                                </div>
                                            </div>
                                            <div class="col-xs-4">
                                                <div class="form-material form-material-primary">
                                                    <input class="form-control" type="number" id="precioDistribuidor" name="precioDistribuidor" value="<?php echo $row_productoEdit["precioDistribuidor"]; ?>">
                                                    <label for="precioDistribuidor">Precio Distribuidor</label>
                                                </div>
                                            </div>
                                            <div class="col-xs-4">
                                                <div class="form-material form-material-primary">
                                                    <input class="form-control" type="number" id="precioOferta" name="precioOferta" value="<?php echo $row_productoEdit["precioOferta"]; ?>">
                                        ...
                                        <div class="form-group">
                                            <div class="col-md-12">
                                                <div class="input-group">
                                                    <input class="form-control" type="text" id="imagen1" name="imagen1" placeholder="Selecciona una imagen (600x600 px)" readonly required value="<?php echo $row_productoEdit["imagen1"]; ?>">
                                        ...
                                        <div class="form-group">
                                            <div class="col-md-12">
                                                <div class="input-group">
                                                    <input class="form-control" type="text" id="imagen2" name="imagen2" placeholder="Selecciona una imagen (600x600 px)" readonly required value="<?php echo $row_productoEdit["imagen2"]; ?>">
                                                    <span class="input-group-btn">
                                        ...
                                        <div class="form-group">
                                            <div class="col-md-12">
                                                <div class="input-group">
                                                    <input class="form-control" type="text" id="imagen3" name="imagen3" placeholder="Selecciona una imagen (600x600 px)" readonly required value="<?php echo $row_productoEdit["imagen3"]; ?>">
                                                    <span class="input-group-btn">
                                        ...
                                        <div class="form-group">
                                            <div class="col-xs-12">
                                                <div class="form-material form-material-primary">
                                                    <input class="js-tags-input form-control" type="text" id="keywords" name="keywords" value="<?php echo $row_productoEdit["keywords"]; ?>">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-xs-12">
                                                <label class="css-input css-radio css-radio-primary push-10-r">
                                                    <input type="radio" id="con-stock" name="stock" value="1" <?php if ($row_productoEdit["stock"] == '1') {echo"checked";}?>><span></span> Con Stock
                                                </label>
                                                <label class="css-input css-radio css-radio-primary">
                                                    <input type="radio" id="sin-stock" name="stock" value="0" <?php if ($row_productoEdit["stock"] == '1') {echo"checked";}?>><span></span> Sin Stock
                                                </label>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-xs-12">
                                                <label class="css-input switch switch-sm switch-primary">
                                                    <input type="checkbox" id="novedad" name="novedad" <?php if ($row_productoEdit["novedad"] == '1') {echo"checked";}?>><span></span>
                                                </label>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-xs-12">
                                                <label class="css-input switch switch-sm switch-primary">
                                                    <input type="checkbox" id="recomendado" name="recomendado" <?php if ($row_productoEdit["recomendado"] == '1') {echo"checked";}?>><span></span>
                                                </label>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-xs-12">
                                                <label class="css-input switch switch-sm switch-primary">
                                                    <input type="checkbox" id="estado" name="estado" <?php if ($row_productoEdit["estado"] == '1') {echo"checked";}?>><span></span>
                                                </label>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="col-xs-12">
                                        		...
                                        		<input type="hidden" name="MM_update" value="productosForm">
                                            </div>
                                        </div>
                                    </form>
                                </div>
