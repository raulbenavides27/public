...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "postVentaForm")) {
  $insertSQL = sprintf("INSERT INTO postVenta (contenido, imagen1, imagen2, imagen3, fechaID, estado) VALUES (%s, %s, %s, %s, %s, %s)",
...
$query_contenidoPostVenta = "SELECT * FROM postVenta ORDER BY postVenta.id DESC";
$contenidoPostVenta = mysqli_query($DKKadmin, $query_contenidoPostVenta) or die(mysqli_error($DKKadmin));
$row_contenidoPostVenta = mysqli_fetch_assoc($contenidoPostVenta);
$totalRows_contenidoPostVenta = mysqli_num_rows($contenidoPostVenta);
?>
<!DOCTYPE html>
    ...
    <body>
        ...
        <div id="page-container" class="sidebar-l sidebar-o side-scroll header-navbar-fixed">
            ...
            <main id="main-container">
                ...
                {
                    self.name = 'opener';
                    remote = open('up/postventa1.php', 'remote', 'width=410,height=200,location=no,scrollbar=no,menubars=no,toolbars=no,resizable=no,fullscreen=no, status=yes');
                    remote.focus();
                    }	
                function upload2()
                {
                    self.name = 'opener';
                    remote = open('up/postventa2.php', 'remote', 'width=410,height=200,location=no,scrollbar=no,menubars=no,toolbars=no,resizable=no,fullscreen=no, status=yes');
                    remote.focus();
                    }	
                function upload3()
                {
                    self.name = 'opener';
                    remote = open('up/postventa3.php', 'remote', 'width=410,height=200,location=no,scrollbar=no,menubars=no,toolbars=no,resizable=no,fullscreen=no, status=yes');
                    remote.focus();
                    }	
                </script>
                <!-- fin script -->
                ...
                <div class="content content-boxed">
                    ...
                    <div class="block">
                        <div class="block-header bg-gray-lighter">
                            <h3 class="block-title">Post Venta</h3>
                        </div>
                        <div class="block-content block-content-full">
                            <div class="row">
                                <div class="col-sm-8 col-sm-offset-2 col-lg-6 col-lg-offset-3">
                                    <form action="<?php echo $editFormAction; ?>" class="form-horizontal push-30-t push-30" method="post" name="postVentaForm">
                                        <div class="form-group">
                                            ...
                                            <div class="col-xs-12 push-10">
                                                <!-- CKEditor Container -->
                                                <textarea id="js-ckeditor" name="contenido"><?php echo $row_contenidoPostVenta["contenido"]; ?></textarea>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="col-md-12">
                                                <div class="input-group">
                                                    <label for="imagen">Fotograf&iacute;as (525x380 px)</label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="col-md-12">
                                                <div class="input-group">
                                                    <input class="form-control" type="text" id="imagen" name="imagen" placeholder="Selecciona una imagen (525x380 px)" readonly required value="<?php echo $row_contenidoPostVenta["imagen1"]; ?>">
                                        ...
                                        <div class="form-group">
                                            <div class="col-md-12">
                                                <div class="input-group">
                                                    <input class="form-control" type="text" id="imagen" name="imagen" placeholder="Selecciona una imagen (525x380 px)" readonly required value="<?php echo $row_contenidoPostVenta["imagen2"]; ?>">
                                                    <span class="input-group-btn">
                                        ...
                                        <div class="form-group">
                                            <div class="col-md-12">
                                                <div class="input-group">
                                                    <input class="form-control" type="text" id="imagen" name="imagen" placeholder="Selecciona una imagen (525x380 px)" readonly required value="<?php echo $row_contenidoPostVenta["imagen3"]; ?>">
                                                    <span class="input-group-btn">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-xs-12">
                                                <label class="css-input switch switch-sm switch-primary">
                                                    <input type="checkbox" id="estado" name="estado" <?php if ($row_contenidoPostVenta["estado"] == '1') {echo "checked";} ?>><span></span>
                                                </label>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="col-xs-12">
                                        		...
                                        		<input type="hidden" name="MM_insert" value="postVentaForm">
                                            </div>
                                        </div>
                                    </form>
                                </div>
...
mysqli_free_result($contenidoPostVenta);
?>
