...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "adminForm")) {
  $updateSQL = sprintf("UPDATE admin SET nombre=%s, apellido=%s, avatar=%s, correo=%s, password=%s, estado=%s WHERE id=%s",
...
<!--[if gt IE 9]><!--> <html class="no-focus" lang="es"><!-- InstanceBegin template="/Templates/admin.dwt.php" codeOutsideHTMLIsLocked="false" --> <!--<![endif]-->
    ...
    <body>
        ...
        <div id="page-container" class="sidebar-l sidebar-o side-scroll header-navbar-fixed">
            ...
            <main id="main-container">
                ...
                {
                    self.name = 'opener';
                    remote = open('up/admin.php', 'remote', 'width=410,height=200,location=no,scrollbar=no,menubars=no,toolbars=no,resizable=no,fullscreen=no, status=yes');
                                ...
                                <div class="col-sm-8 col-sm-offset-2 col-lg-6 col-lg-offset-3">
                                    ...
                                    <div class="block">
                                        <div class="block-content">
                                          <form method="POST" action="<?php echo $editFormAction; ?>" class="form-horizontal push-10-t push-10" name="adminForm">
                                                <div class="form-group">
                                                    <div class="col-xs-6">
                                                        <div class="form-material">
                                                            <input class="form-control" type="text" id="nombre" name="nombre" placeholder="Ingresa tu Nombre" required value="<?php echo $row_datosAdmin["nombre"]; ?>">
                                                            <label for="nombre">Nombre</label>
                                                        </div>
                                                    </div>
                                                    <div class="col-xs-6">
                                                        <div class="form-material">
                                                            <input class="form-control" type="text" id="apellido" name="apellido" placeholder="Ingresa tu Apellido" required value="<?php echo $row_datosAdmin["apellido"]; ?>">
                                                ...
                                                <div class="form-group">
                                                    <div class="col-xs-12">
                                                        <div class="form-material input-group">
                                                            <input class="form-control" type="text" id="avatar" name="avatar" placeholder="Selecciona tu avatar" required readonly value="<?php echo $row_datosAdmin["avatar"]; ?>">
                                                            <label for="avatar">Avatar (450x450px)</label>
                                                ...
                                                <div class="form-group">
                                                    <div class="col-xs-12">
                                                        <div class="form-material input-group">
                                                            <input class="form-control" type="email" id="correo" name="correo" placeholder="Ingresa tu correo electr&oacute;nico" value="<?php echo $row_datosAdmin["correo"]; ?>">
                                                ...
                                                <div class="form-group">
                                                    <div class="col-xs-6">
                                                        <div class="form-material input-group">
                                                            <input class="form-control" type="password" id="passwordValidar" name="passwordValidar" placeholder="Ingresa una nueva Contraseña" value="<?php echo $row_datosAdmin["password"]; ?>">
                                                    ...
                                                    <div class="col-xs-6">
                                                        <div class="form-material input-group">
                                                            <input class="form-control" type="password" id="password" name="password" placeholder="Confirma tu nueva Contraseña" value="<?php echo $row_datosAdmin["password"]; ?>">
                                                ...
                                                <div class="form-group">
                                                    <div class="col-xs-12">
                                                        <label class="css-input css-checkbox css-checkbox-primary">
                                                            <input <?php if (!(strcmp($row_datosAdmin['estado'],1))) {echo "checked=\"checked\"";} ?> type="checkbox" id="estado" name="estado"><span></span> ¿Activo?
                                                        </label>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <div class="col-xs-12">
                                                        <input type="hidden" name="id" value="<?php echo $row_datosAdmin["id"]; ?>">
                                                        <button class="btn btn-block btn-primary" type="submit"><i class="fa fa-save push-5-r"></i> Guardar Cambios</button>
                                                    </div>
                                                </div>
                                                
                                                <input type="hidden" name="MM_update" value="adminForm">
                                            </form>
                                        </div>
                                    </div>
                                </div>
    ...
    <script src="js/core/jquery.min.js"></script>
        ...
        <script>
			$(document).ready(function($DKKadmin) {
				//variables
				...
				function coincidePassword($DKKadmin){
				var valor1 = pass1.val($DKKadmin);
				var valor2 = pass2.val($DKKadmin);
				//muestro el span
				span.show($DKKadmin).removeClass($DKKadmin);
				...
				pass2.keyup(function($DKKadmin){
				coincidePassword($DKKadmin);
				});
			});
        </script>
		<!-- InstanceEndEditable -->
