...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "categoriasForm")) {
  $updateSQL = sprintf("UPDATE menuCategorias SET categoria=%s, categoriaSEO=%s, titulo=%s, bajada=%s, imagen=%s, keywords=%s, estado=%s WHERE id=%s",
...
$query_categoriasEdit = sprintf("SELECT * FROM menuCategorias WHERE menuCategorias.id = '$idCategoria'");
$categoriasEdit = mysqli_query($DKKadmin, $query_categoriasEdit) or die(mysqli_error($DKKadmin));
$row_categoriasEdit = mysqli_fetch_assoc($categoriasEdit);
$totalRows_categoriasEdit = mysqli_num_rows($categoriasEdit);
?>
<!DOCTYPE html>
    ...
    <body>
        ...
        <div id="page-container" class="sidebar-l sidebar-o side-scroll header-navbar-fixed">
            ...
            <main id="main-container">
                ...
                {
                    self.name = 'opener';
                    remote = open('up/categorias.php', 'remote', 'width=410,height=200,location=no,scrollbar=no,menubars=no,toolbars=no,resizable=no,fullscreen=no, status=yes');
                    remote.focus();
                    }	
                </script>
                <!-- fin script -->
                    ...
                    <div class="row items-push">
                        <div class="col-sm-7">
                            <h1 class="page-heading">
                                Categor&iacute;as <small>Estas son las categorías presentes en la tienda</small>
                            </h1>
                        </div>
                        <div class="col-sm-5 text-right hidden-xs">
                            <ol class="breadcrumb push-10-t">
                                <li>Dashboard</li>
                                <li><a class="link-effect" href="">Categor&iacute;as</a></li>
                            </ol>
                        </div>
                    </div>
                </div>
                ...
                <div class="content">
                    <div class="row">
                        <div class="col-lg-8">
                            ...
                            <div class="block">
                                <div class="block-header">
                                    <h3 class="block-title">Categor&iacute;as</h3>
                                </div>
                                <div class="block-content">
                                    <table class="table table-bordered table-striped js-dataTable-full">
                                        ...
                                        <tbody>
                                            <?php do { ?>
                                            <tr>
                                                <td class="text-center">#CT0<?php echo $row_categoriasProductos["id"]; ?></td>
                                                <td class="font-w600"><?php echo $row_categoriasProductos["categoria"]; ?></td>
                                                <td class="hidden-xs"><?php echo $row_categoriasProductos["visitas"]; ?></td>
                                                <td class="hidden-xs">
                                                  <span class="label label-<?php if ($row_categoriasProductos["estado"] == '1') { echo "success";} if ($row_categoriasProductos["estado"] == '2') { echo "warning";} if ($row_categoriasProductos["estado"] == '0') { echo "default";} ?>"><?php if ($row_categoriasProductos["estado"] == '1') { echo "ACTIVA";} if ($row_categoriasProductos["estado"] == '2') { echo "INACTIVA";} if ($row_categoriasProductos["estado"] == '0') { echo "ELIMINADA";} ?></span>
                                                </td>
                                                <td class="text-center">
                                                  <div class="btn-group">
                                                    <button class="btn btn-xs btn-default" type="button" data-toggle="tooltip" title="Editar Categoría" onClick="location.href='categorias_edit.php?id=<?php echo $row_categoriasProductos["id"]; ?>'"><i class="fa fa-pencil"></i></button>
                                                    <button class="btn btn-xs btn-default" type="button" data-toggle="tooltip" title="Eliminar Categoría" onClick="location.href='categorias_remove.php?id=<?php echo $row_categoriasProductos["id"]; ?>'"><i class="fa fa-times"></i></button>
                                                    </div>
                                                </td>
                                            </tr>
                        ...
                        <div class="col-lg-4">
                            ...
                            <div class="block">
                                <div class="block-header">
                                    <h3 class="block-title">Editar Categor&iacute;a</h3>
                                </div>
                                <div class="block-content">
                                  <form action="<?php echo $editFormAction; ?>" class="form-horizontal push-10-t push-10" method="POST" name="categoriasForm">
                                        <div class="form-group">
                                            <label class="col-xs-12">ID</label>
                                            <div class="col-xs-12">
                                                <div class="form-control-static">#CT0<?php echo  $row_categoriasEdit["id"]; ?></div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="col-xs-12">
                                                <div class="form-material">
                                                    <input class="form-control" type="text" id="categoria" name="categoria" placeholder="Ingresa el Nombre" value="<?php echo  $row_categoriasEdit["categoria"]; ?>">
                                        ...
                                        <div class="form-group">
                                            <div class="col-xs-12">
                                                <div class="form-material">
                                                    <input class="form-control" type="text" id="categoriaSEO" name="categoriaSEO" placeholder="Ingresa el Nombre SEO" value="<?php echo  $row_categoriasEdit["categoriaSEO"]; ?>">
                                                    <label for="categoriaSEO">SEO Categoría</label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="col-xs-12">
                                                <div class="form-material">
                                                    <input class="form-control" type="text" id="titulo" name="titulo" placeholder="Ingresa el T&iacute;tulo de la Categor&iacute;a" value="<?php echo  $row_categoriasEdit["titulo"]; ?>">
                                        ...
                                        <div class="form-group">
                                            <div class="col-xs-12">
                                                <div class="form-material">
                                                    <textarea class="form-control" id="descripbajadacion" name="bajada" rows="3" placeholder="Ingresa una descripci&oacute;n para la categor&iacute;a"><?php echo  $row_categoriasEdit["bajada"]; ?></textarea>
                                        ...
                                        <div class="form-group">
                                            <div class="col-md-12">
                                                <div class="input-group">
                                                    <input class="form-control" type="text" id="imagen" name="imagen" placeholder="Selecciona una imagen (850x350 px)" readonly required value="<?php echo  $row_categoriasEdit["imagen"]; ?>">
                                        ...
                                        <div class="form-group">
                                            <div class="col-xs-12">
                                                <div class="form-material form-material-primary">
                                                    <input class="js-tags-input form-control" type="text" id="keywords" name="keywords" value="<?php echo  $row_categoriasEdit["keywords"]; ?>">
                                        ...
                                        <div class="form-group">
                                            <div class="col-xs-12">
                                                <label class="css-input switch switch-sm switch-success">
                                                    <input type="checkbox" id="estado" name="estado" <?php if ($row_categoriasEdit["estado"] == '1') {echo"checked";}?>><span></span> Estado
                                                </label>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <input type="hidden" name="id" value="<?php echo  $row_categoriasEdit["id"]; ?>">
                                        <input type="hidden" name="MM_update" value="categoriasForm">
                                    </form>
                                </div>
                            </div>
                            <!-- END formulario -->
...
mysqli_free_result($categoriasEdit);
?>
