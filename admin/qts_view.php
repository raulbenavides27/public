...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "editarProductoForm")) {
  ...
  $updateGoTo = "qts_productos_edit.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
<!--[if gt IE 9]><!--> <html class="no-focus" lang="es"><!-- InstanceBegin template="/Templates/admin.dwt.php" codeOutsideHTMLIsLocked="false" --> <!--<![endif]-->
                    ...
                    <div class="row items-push">
                        <div class="col-sm-7">
                            <h1 class="page-heading">
                                Cotización <small>Ver Cotización</small>
                            </h1>
                        </div>
                        <div class="col-sm-5 text-right hidden-xs">
                            <ol class="breadcrumb push-10-t">
                                <li>Dashboard</li>
                                <li><a class="link-effect" href="">Ver Cotización</a></li>
                            </ol>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="block">
                        <div class="block-header">
                            <ul class="block-options">
                                ...
                                <li>
                                    <button type="button" onClick="location.href='qts_edit.php?id=<?php echo $row_qtsCotizacionEditar["id"]; ?>'"><i class="si si-pencil"></i> Editar</button>
                                </li>
                                <li>
    ...
    <script src="js/core/jquery.min.js"></script>
        ...
        <script type="text/javascript">
			...
			$('#btnDsctoEditar').change(function() {
				$('#btnDsctoActivoEditar').toggle();
			});        
		</script>
        <!-- InstanceEndEditable -->
</body>
