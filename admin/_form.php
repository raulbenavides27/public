                ...
                <div class="content content-boxed">
                            ...
                            <div class="row">
                                <div class="col-sm-8 col-sm-offset-2 col-lg-6 col-lg-offset-3">
                                    <form class="form-horizontal push-30-t push-30" action="base_pages_ecom_product_edit.html" method="post" onsubmit="return false;">
                                        ...
                                        <div class="form-group">
                                            <div class="col-xs-12">
                                                <!-- Select2 (.js-select2 class is initialized in App($DKKadmin) -> uiHelperSelect2($DKKadmin)) -->
                    ...
                    <div class="block">
                        ...
                        <div class="block-content block-content-full">
                            <div class="row">
                                <div class="col-sm-8 col-sm-offset-2 col-lg-6 col-lg-offset-3">
                                    <!-- Bootstrap Maxlength (.js-maxlength class is initialized in App($DKKadmin) -> uiHelperMaxlength($DKKadmin)) -->
                                    ...
                                    <form class="form-horizontal push-30-t push-30" action="base_pages_ecom_product_edit.html" method="post" onsubmit="return false;">
                                        ...
                                        <div class="form-group">
                                            <div class="col-xs-12">
                                                <div class="form-material form-material-primary">
                                                    <!-- jQuery Tags Input (.js-tags-input class is initialized in App($DKKadmin) -> uiHelperTagsInput($DKKadmin)) -->
