...
;
$query_contactosShow = "SELECT * FROM contacto WHERE contacto.estado = '1' ORDER BY contacto.id DESC";
...
;
$query_contactosShowTodos = "SELECT * FROM contacto WHERE contacto.estado = '1' ORDER BY contacto.id DESC";
