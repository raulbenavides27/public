...
;
$query_contactosShow = "SELECT * FROM contacto WHERE contacto.respondido = '1' AND NOT contacto.estado = '0' ORDER BY contacto.id DESC";
...
;
$query_contactosShowTodos = "SELECT * FROM contacto WHERE contacto.respondido = '1' AND NOT contacto.estado = '0' ORDER BY contacto.id DESC";
