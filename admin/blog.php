...
$query_blogTodos = "SELECT * FROM blog WHERE NOT blog.estado = '0' ORDER BY blog.id ASC";
$blogTodos = mysqli_query($DKKadmin, $query_blogTodos) or die(mysqli_error($DKKadmin));
$row_blogTodos = mysqli_fetch_assoc($blogTodos);
$totalRows_blogTodos = mysqli_num_rows($blogTodos);

$query_blogActivos = "SELECT * FROM blog WHERE blog.estado = '1' ORDER BY blog.id ASC";
$blogActivos = mysqli_query($DKKadmin, $query_blogActivos) or die(mysqli_error($DKKadmin));
$row_blogActivos = mysqli_fetch_assoc($blogActivos);
$totalRows_blogActivos = mysqli_num_rows($blogActivos);

$query_blogInactivos = "SELECT * FROM blog WHERE blog.estado = '2' ORDER BY blog.id ASC";
$blogInactivos = mysqli_query($DKKadmin, $query_blogInactivos) or die(mysqli_error($DKKadmin));
$row_blogInactivos = mysqli_fetch_assoc($blogInactivos);
$totalRows_blogInactivos = mysqli_num_rows($blogInactivos);
?>
<!DOCTYPE html>
                    ...
                    <div class="row items-push">
                        <div class="col-sm-7">
                            <h1 class="page-heading">
                                Blog <small>Estos son los posts publicadas en nuestra web.</small>
                            </h1>
                        </div>
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="row">
                               <div class="col-sm-6 col-md-3">
                                    <a class="block block-link-hover3 text-center" href="blog_add.php">
                                ...
                                <div class="col-sm-6 col-md-3">
                                    <a class="block block-link-hover3 text-center" href="javascript:void(0)">
                                        <div class="block-content block-content-full">
                                            <div class="h1 font-w700" data-toggle="countTo" data-to="<?php echo $totalRows_blogTotal; ?>"></div>
                                        </div>
                                ...
                                <div class="block-content">
                                    ...
                                    <table class="table table-bordered table-striped js-dataTable-full">
                                        ...
                                        <tbody>
                                            <?php do { ?>
                                            <tr>
                                                <td class="text-center"><?php echo $row_blogTodos["id"]; ?></td>
                                                <td class="font-w600"><?php echo $row_blogTodos["titulo"]; ?></td>
                                                <td class="hidden-xs"><?php echo strtoupper(str_replace("-"," ",$row_blogTodos["categoriaSEO"])); ?></td>
                                                <td class="hidden-xs">
                                                  <span class="label label-<?php if ($row_blogTodos["estado"] == '1') {echo"success";}; if ($row_blogTodos["estado"] == '2') {echo"warning";};if ($row_blogTodos["estado"] == '0') {echo"danger";};  ?>"><?php if ($row_blogTodos["estado"] == '1') {echo"ACTIVO";}; if ($row_blogTodos["estado"] == '2') {echo"INACTIVO";};if ($row_blogTodos["estado"] == '0') {echo"ELIMINADO";};  ?></span>
                                                </td>
                                                <td class="text-center">
                                                  <div class="btn-group">
                                                    <button class="btn btn-xs btn-default" type="button" data-toggle="tooltip" title="Editar Noticia" onClick="location.href='blog_edit.php?id=<?php echo $row_blogTodos["id"]; ?>'"><i class="fa fa-pencil"></i></button>
                                                    <button class="btn btn-xs btn-default" type="button" data-toggle="tooltip" title="Eliminar Noticia" onClick="location.href='blog_remove.php?id=<?php echo $row_blogTodos["id"]; ?>'"><i class="fa fa-times"></i></button>
                                                    </div>
                                                </td>
                                              </tr>
                                              <?php } while ($row_blogTodos = mysqli_fetch_assoc($blogTodos)); ?>
                                        </tbody>
                                    </table>
                                </div>
                            </div>
...
mysqli_free_result($blogTodos);

mysqli_free_result($blogActivos);

mysqli_free_result($blogInactivos);
?>
