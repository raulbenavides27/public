...
$query_cotizacionReply = "SELECT * FROM cotizaciones WHERE cotizaciones.estado = '2' ORDER BY cotizaciones.fechaReply DESC LIMIT 1";
$cotizacionReply = mysqli_query($DKKadmin, $query_cotizacionReply) or die(mysqli_error($DKKadmin));
$row_cotizacionReply = mysqli_fetch_assoc($cotizacionReply);
$totalRows_cotizacionReply = mysqli_num_rows($cotizacionReply);
?>
<?
$destinatario = "{$row_cotizacionReply['correo']}";
$asunto = "Hola {$row_cotizacionReply['nombre']}, te estamos respondido desde prodalum.cl.";
...
<title>Prodalum | Lideres en Seguridad y Equipamiento Minero</title>
...
<div class='wrapper'>
    <div class='cuerpo'>
        <div class='contenido'>
            ...
            <!-- contenido -->
            <div class='mensaje'>
            	<h3>Hola  <b>{$row_cotizacionReply['nombre']}</b></h3>
                <p>Te estamos respondiendo desde prodalum.cl:</p>
                <p>
                <blockquote>{$row_cotizacionReply['mensaje']}</blockquote><br />
              </p>
...
$headers .= "From: Prodalum <prodalum.cl@prodalum.cl>\r\n";
...
?>
<META HTTP-EQUIV='Refresh' CONTENT='0; URL=cotizaciones_respondidas.php'>
<?php
mysqli_free_result($datosAdmin);

mysqli_free_result($cotizacionReply);
?>
