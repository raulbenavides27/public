...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "notasForm")) {
  ...
  $insertGoTo = "qts_clientes-view.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "clienteForm")) {
  ...
  $updateGoTo = "qts_clientes-view.php";
  if (isset($_SERVER['QUERY_STRING'])) {
                                            ...
                                            <tr style="font-size:12px;">
                                                ...
                                                <td class="text-center">
                                                  <div class="btn-group">
                                                    ...
                                                    <button class="btn btn-xs btn-default" type="button" data-toggle="tooltip" title="Eliminar Contacto" onClick="location.href='qts_clientes-contactos-remove.php?id=<?php echo $row_qtsContactosClientes["id"]; ?>'"><i class="fa fa-times"></i></button>
                                                    </div>
                                                </td>
                                              </tr>
                                            ...
                                            <tr style="font-size:12px;">
                                                ...
                                                <td class="text-center">
                                                  <div class="btn-group">
                                                    ...
                                                    <button class="btn btn-xs btn-default" type="button" data-toggle="tooltip" title="Eliminar Dirección" onClick="location.href='qts_clientes-direcciones-remove.php?id=<?php echo $row_qtsDireccionesClientes["id"]; ?>'"><i class="fa fa-times"></i></button>
                                                    </div>
                                                </td>
                                              </tr>
