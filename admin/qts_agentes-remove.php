...
$query_ConsultaChange = sprintf("SELECT * FROM admin WHERE admin.id = %s", GetSQLValueString($varID_ConsultaChange, "int"));
...
//Actualizar Estado
  $updateSQL = sprintf("UPDATE admin SET admin.estado = '0' WHERE admin.id = %s",GetSQLValueString($varID_ConsultaChange, "int"));
