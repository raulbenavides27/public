...
$query_cotizacionesShow = "SELECT * FROM cotizaciones WHERE cotizaciones.urgente = '1' AND NOT cotizaciones.estado = '0' ORDER BY cotizaciones.id DESC";
...
$query_cotizacionesShowTodos = "SELECT * FROM cotizaciones WHERE cotizaciones.urgente = '1' AND NOT cotizaciones.estado = '0' ORDER BY cotizaciones.id DESC";
