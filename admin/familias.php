...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "familiasForm")) {
  $updateSQL = sprintf("INSERT INTO menuSubCategoriasFamilias (subCategoriaSEO, subCategoriaFamiliaSEO, subCategoriaFamilia, estado) VALUES (%s, %s, %s, %s)",
  ...
  $insertGoTo = "familias_categoria.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
$query_subCategoriasProductos = sprintf("SELECT * FROM menuSubCategorias ORDER BY menuSubCategorias.id DESC");
                                ...
                                <div class="block-content">
                                  <form action="<?php echo $editFormAction; ?>" class="form-horizontal push-10-t push-10" method="POST" name="familiasForm">
                                        <div class="form-group">
                                            ...
                                            <div class="col-xs-12">
                                                <div class="form-control-static">#FSC0<?php echo ($row_familiasProductos["id"] +1); ?></div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="col-xs-12">
                                        ...
                                        <div class="form-group">
                                            <div class="col-xs-12">
                                                <div class="form-material">
                                                    <input class="form-control" type="text" id="subCategoriaFamilia" name="subCategoriaFamilia" placeholder="Ingresa el Nombre de la Familia">
                                        ...
                                        <div class="form-group">
                                            <div class="col-xs-12">
                                                <div class="form-material">
                                                    <input class="form-control" type="text" id="subCategoriaFamiliaSEO" name="subCategoriaFamiliaSEO" placeholder="Ingresa el SEO de la Familia">
                                        ...
                                        <input type="hidden" name="MM_insert" value="familiasForm">
                                    </form>
                                </div>
                            </div>
                            <!-- END formulario -->
