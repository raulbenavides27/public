...
$query_sliderBanner = "SELECT * FROM banners WHERE banners.estado = '1' AND banners.tipo = '2' ORDER BY banners.id DESC";
$sliderBanner = mysqli_query($DKKfront, $query_sliderBanner);
$row_sliderBanner = mysqli_fetch_assoc($sliderBanner);
$totalRows_sliderBanner = mysqli_num_rows($sliderBanner);

$query_homeBanner = "SELECT * FROM banners WHERE banners.estado = '1' AND banners.tipo = '1' AND NOT banners.id = '2' ORDER BY banners.id DESC";
...
<div id="page"> 
  ...
  <div class="jtv-slideshow">
    <div class="container">
      <div class="row">
		<div class="col-md-3 col-sm-3 banner-left">
		  <img class="hidden-xs" src="../images/banner_left_home.jpg" alt="banner">
		  <div class="jtv-banner3">
            <div class="jtv-banner3-inner"><a href="<?php echo $row_sliderBanner["link"]; ?>" target="_blank"><img src="../images/<?php echo $row_sliderBanner["imagen"]; ?>" alt="Visítanos"></a>
              <div class="hover_content">
                <!-- <div class="hover_data">
                  <div class="title" style="margin-top: -40px; color:#EAEAEA;"> <?php echo $row_sliderBanner["titulo"]; ?> </div>
                  <div class="desc-text" style="color:#CA0C0F;"><?php echo $row_sliderBanner["llamado"]; ?></div>
                  <span style="color:#EAEAEA;"><?php echo $row_sliderBanner["bajada"]; ?></span>
                  <p style="color:#EAEAEA;"><a href="<?php echo $row_sliderBanner["link"]; ?>" class="shop-now" target="_blank"><?php echo $row_sliderBanner["accion"]; ?></a></p>
                </div> -->
              </div>
            </div>
          </div>
		</div>
		<div class="col-md-9 col-sm-9 jtv-slideshow">
            ...
            <div id='rev_slider_4_wrapper' class='rev_slider_wrapper fullwidthbanner-container' >
              <div id='rev_slider_4' class='rev_slider fullwidthabanner'>
                ...
                <?php do { ?>
                  ...
                  <li data-transition='fade' data-slotamount='7' data-masterspeed='2000' data-thumb=''><img src='../images/slider/<?php echo $row_homeSlider["imagen"]; ?>' data-bgposition='left top' data-bgfit='cover' data-bgrepeat='no-repeat' alt="<?php echo $row_homeSlider["titular"]." | ".$row_homeSlider["llamado"]." | ".$row_homeSlider["bajada"]; ?>"/>
                  ...
                  <li data-transition='fade' data-slotamount='7' data-masterspeed='2000' data-thumb=''><img src='../images/slider/<?php echo $row_homeSlider["imagen"]; ?>' data-bgposition='left top' data-bgfit='cover' data-bgrepeat='no-repeat' alt="<?php echo $row_homeSlider["titular"]." | ".$row_homeSlider["llamado"]." | ".$row_homeSlider["bajada"]; ?>"/>
                    <div class="caption-inner left">
                      <div class='tp-caption LargeTitle sft  tp-resizeme' data-x='50'  data-y='110'  data-endspeed='500'  data-speed='500' data-start='1300' data-easing='Linear.easeNone' data-splitin='none' data-splitout='none' data-elementdelay='0.1' data-endelementdelay='0.1' style='z-index:3; white-space:nowrap; color: yellow;'><?php echo $row_homeSlider["llamado"]; ?></div>
                  ...
                  <li data-transition='fade' data-slotamount='7' data-masterspeed='2000' data-thumb=''><img src='../images/slider/<?php echo $row_homeSlider["imagen"]; ?>' data-bgposition='left top' data-bgfit='cover' data-bgrepeat='no-repeat' alt="<?php echo $row_homeSlider["titular"]." | ".$row_homeSlider["llamado"]." | ".$row_homeSlider["llamado2"]." | ".$row_homeSlider["bajada"]; ?>"/>
                    <div class="caption-inner left">
  ...
  <div class="container">
    <div class="home-tab">
      <div class="tab-title text-left">
        <h2>Escalas</h2>
        <ul class="nav home-nav-tabs home-product-tabs align-right">
		  <li class="active"><a href="#aluminio" data-toggle="tab" aria-expanded="false"><strong>Aluminio</strong></a></li>
		  <li><a href="#fibra-de-vidrio" data-toggle="tab" aria-expanded="false"><strong>Fibra de Vidrio</strong></a></li>
		  <li><a href="#acero" data-toggle="tab" aria-expanded="false"><strong>Acero</strong></a></li>
		</ul>
      </div>
