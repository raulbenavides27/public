...
$query_productosShow = "SELECT * FROM productos WHERE productos.estado = '1' AND productos.oferta = '1' ORDER BY productos.id ASC";
...
<title><?php echo $row_metaDatos["titulo"]." | Ofertas Exclusivas"; ?></title>
<!-- InstanceEndEditable -->
...
if (screen.width<500) {
window.location="http://mobile.prodalum.cl/home/#!/../catalogo";
}
</script>
<!-- InstanceEndEditable -->
</head>
      ...
      <div class="row">
        <div class="col-xs-12">
          <ul>
            ...
            <li><strong>Cat&aacute;logo</strong></li>
          </ul>
        </div>
      </div>
    </div>
            ...
            <div class="slider-items-products">
              <div id="category-desc-slider" class="product-flexslider hidden-buttons">
                <div class="slider-items slider-width-col1 owl-carousel owl-Template"> 
                  ...
                  <!-- head -->
                  <div class="item"> <a href="#"><img alt="<?php echo "Ofertas Exclusivas | ".$row_metaDatos["titulo"]; ?>" src="../images/catalogo/bg_catalogo.jpg"></a>
                    <div class="inner-info">
                      <div class="cat-img-title"> <span>Ofertas Exclusivas</span>
                        <h2 class="cat-heading">Nuestros productos con precios irrepetibles</h2>
                        <p>Ofertas exclusivas por un tiempo limitado. ¡Aprov&eacute;chalas!</p>
                        <!-- <a class="info" href="../catalogo">Ir al Cat&aacute;logo</a>  -->
                      </div>
                    </div>
                  </div>
                  <!-- END head --> 
...
mysqli_free_result($familiasEscalas);

mysqli_free_result($productosRecomendados);

mysqli_free_result($escalasCapMax);

mysqli_free_result($escalasEtiquetas);

mysqli_free_result($escalasUsos);

mysqli_free_result($categoriaSelect);

mysqli_free_result($productosShow);

mysqli_free_result($categoriasSide);
