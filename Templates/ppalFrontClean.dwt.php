...
$metaDatos = mysqli_query($query_metaDatos, $DKKfront) or die(mysqli_error());
...
$menuMovil = mysqli_query($query_menuMovil, $DKKfront) or die(mysqli_error());
...
$categoriasMenu = mysqli_query($query_categoriasMenu, $DKKfront) or die(mysqli_error());
...
$categoriasFooter = mysqli_query($query_categoriasFooter, $DKKfront) or die(mysqli_error());
