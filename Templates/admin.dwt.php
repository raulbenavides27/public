                    ...
                    <div class="sidebar-content">
                        ...
                        <div class="side-content side-content-full">
                            <ul class="nav-main">
                                ...
                                <li>
                                    <a href="../admin/qts_dashboard.php"><i class="si si-graph"></i><span class="sidebar-mini-hide">Dashboard</span></a>
                                </li>
                                <li>
                                    <a href="../admin/qts_cotizaciones.php"><i class="si si-briefcase"></i><span class="sidebar-mini-hide">Cotizaciones</span></a>
                                </li>
                                <li>
                                    <a class="nav-submenu" data-toggle="nav-submenu" href="#"><i class="si si-users"></i><span class="sidebar-mini-hide">Clientes</span></a>
                                    <ul>
                                        <li>
                                            <a href="../admin/clientes.php">Todos</a>
                                        </li>
                                        <li>
                                        	<a href="../admin/clientes-add.php">Nuevo</a>
                                        </li>
                                    </ul>
                                </li>
                                ...
                                <li>
                                    ...
                                    <ul>
                                        <li>
                                            <a href="../admin/categorias.php">Categor&iacute;as</a>
                                        </li>
                                        <li>
                                            <a href="../admin/subcategorias.php">SubCategor&iacute;as</a>
                                        </li>
                                        <li>
                                            <a href="../admin/familias.php">Familias</a>
                                        </li>
                                    </ul>
                                </li>
                                ...
                                <li>
                                    ...
                                    <ul>
                                        <li>
                                            <a href="../admin/productos.php">Todos los Productos</a>
                                        </li>
                                        <li>
                                            <a href="../admin/productos_add.php">Nuevo Productos</a>
                                        </li>
                                    </ul>
                                </li>
                                ...
                                <li>
                                    ...
                                    <ul>
                                        <li>
                                            <a href="../admin/home_slider.php">Slider</a>
                                        </li>
                                        <li>
                                            <a href="../admin/home_categorias.php">Categor&iacute;as</a>
                                        </li>
                                        <li>
                                            <a href="../admin/home_banner.php">Banner</a>
                                        </li>
                                    </ul>
                                </li>
                                ...
                                <li>
                                    ...
                                    <ul>
                                        <li>
                                            <a href="../admin/nosotros.php">Historia</a>
                                        </li>
                                        <li>
                                            <a href="../admin/mision.php">Misi&oacute;n</a>
                                        </li>
                                        <li>
                                          <a href="../admin/postventa.php">Post-Venta</a>
                                        </li>
                                        <li>
                                            <a href="../admin/representantes.php">Representantes</a>
                                        </li>
                                    </ul>
                                </li>
                                ...
                                <li>
                                    ...
                                    <ul>
                                        <li>
                                            <a href="../admin/blog.php">Todos los Posts</a>
                                        </li>
                                        <li>
                                            <a href="../admin/blog_add.php">Nuevo Post</a>
                                        </li>
                                    </ul>
                                </li>
                    ...
                    <li>
                        <div class="btn-group">
                            <button class="btn btn-default btn-image dropdown-toggle" data-toggle="dropdown" type="button">
                                <img src="../admin/img/avatars/<?php echo $row_datosAdmin["avatar"]; ?>" alt="<?php echo $row_datosAdmin["nombre"]." ".$row_datosAdmin["apellido"]; ?>">
                                <span class="caret"></span>
                            </button>
                            <ul class="dropdown-menu dropdown-menu-right">
                                <li class="dropdown-header">Perfil</li>
                                <li>
                                    <a tabindex="-1" href="../admin/mailbox.php">
                                        <i class="si si-envelope-open pull-right"></i>
                                        <span class="badge badge-primary pull-right"><?php echo $totalRows_mailBox; ?></span>Mailbox
                                  </a>
                                </li>
                                <li>
                                    <a tabindex="-1" href="../admin/miperfil.php">
                                        <i class="si si-user pull-right"></i>Mi Perfil
                                  </a>
                                </li>
                                <li>
                                    <a tabindex="-1" href="../admin/ajustes.php">
                                ...
                                <li>
                                    <a tabindex="-1" href="../admin/lock.php">
                                        <i class="si si-lock pull-right"></i>Bloquear
                                  </a>
                                </li>
                                <li>
                                    <a tabindex="-1" href="../admin/logout.php">
