...
$query_resultadosProductos = "SELECT * FROM productos WHERE productos.keywords LIKE '%$keyword%' AND productos.estado = '1' ORDER BY productos.id DESC";
...
<title><?php echo $row_metaDatos["titulo"]." | Resultados"; ?></title>
<!-- InstanceEndEditable -->
        ...
        <div class="col-main col-sm-9 col-xs-12">
          ...
          <div class="page-content checkout-page">
            ...
            <div class="box-border">
              <?php if ($totalRows_resultadosProductos >= 1) { ?>
                ...
                <table class="table table-bordered cart_summary">
                  ...
                  <tbody>
					...
					<tr>
                        ...
                        <small style="text-transform: none;"><a href="../productos/<?php echo $row_resultadosProductos["nombreSEO"]; ?>" target="_blank"><strong>Descripci&oacute;n:</strong> <?php echo $row_resultadosProductos["descripcionCorta"]; ?></small></td>
			  ...
			  <?php } ?>
              <button class="button pull-right" onClick="location.href='../buscador'"><span>Ir a la b&uacute;squeda avanzada</span></button>
            </div>
          </div>
        </div>
