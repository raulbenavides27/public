        ...
        <div class="row">
          <div class="col-xs-12">
            <ul>
              ...
              <li><strong>Sala de Ventas</strong></li>
            </ul>
          </div>
        </div>
      </div>
            ...
            <div id="contact" class="page-content page-contact">
              ...
              <div class="row">
                <div class="col-xs-12 col-sm-6" id="contact_form_map">
                  <h3 class="page-subheading">Visita nuestra Sala de Ventas</h3>
                  <p>Contamos con sala de exhibici&oacute;n de productos, recepci&oacute;n y estacionamientos. Vis&iacute;tanos cuando quieras.</p>
                  <br/>
                  <ul>
                    <li><i class="fa fa-circle"></i> Sala de Ventas.</li>
                    <li><i class="fa fa-circle"></i> Showroom.</li>
                    <li><i class="fa fa-circle"></i> Sala de Reuniones.</li>
                  </ul>
                  <br/>
                  <ul class="store_info">
                    <li><i class="fa fa-home"></i><?php echo $row_metaDatos["direccion"]; ?></li>
                    ...
                    <li><i class="fa fa-envelope"></i>Email: <span><a href="<?php echo $row_metaDatos["correo"]; ?>"><?php echo $row_metaDatos["correo"]; ?></a></span></li>
                    <li><?php echo $row_metaDatos["horario"]; ?></li>
                  </ul>
                </div>
                <div class="col-sm-6">
                  <div class="contact-form-box">
					<div id="map">
                    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3327.5315600876197!2d-70.61437578479975!3d-33.487544780763244!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x9662d0037af46895%3A0x3c79128c7e307c0a!2sManufacturas+de+Productos+de+Aluminio+Prodalum!5e0!3m2!1ses!2scl!4v1520356632462" width="100%" height="360" frameborder="0" style="border:0" allowfullscreen></iframe>
                    </div>
                  </div>
                </div>
              </div>
